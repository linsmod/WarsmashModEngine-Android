...
//				parser.removeErrorListener(ConsoleErrorListener.INSTANCE);
	...
	private static final class JUIEnvironment {
		...
		public JUIEnvironment(final JassProgramVisitor jassProgramVisitor, final DataSource dataSource,
			...
			jassProgramVisitor.getJassNativeManager().createNative("LogError", (arguments, globalScope, triggerScope) -> {
				final String stringValue = arguments.get(0).visit(StringJassValueVisitor.getInstance());
				System.err.println(stringValue);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("ConvertFramePointType", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("CreateRootFrame", (arguments, globalScope, triggerScope) -> {
				...
				final GameUI gameUI = new GameUI(dataSource, skin, uiViewport, uiScene, war3MapViewer, 0, war3MapViewer.getAllObjectData().getWts());
			...
			jassProgramVisitor.getJassNativeManager().createNative("LoadTOCFile", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("CreateSimpleFrame", (arguments, globalScope, triggerScope) -> {
				...
				final UIFrame simpleFrame = JUIEnvironment.this.gameUI.createSimpleFrame(templateName, ownerFrame, createContext);
				return new HandleJassValue(frameHandleType, simpleFrame);
			});
			jassProgramVisitor.getJassNativeManager().createNative("CreateFrame", (arguments, globalScope, triggerScope) -> {
				final String templateName = arguments.get(0).visit(StringJassValueVisitor.getInstance());
				final UIFrame ownerFrame = arguments.get(1).visit(ObjectJassValueVisitor.<UIFrame>getInstance());
				...
				final UIFrame simpleFrame = JUIEnvironment.this.gameUI.createFrame(templateName, ownerFrame, priority, createContext);
				return new HandleJassValue(frameHandleType, simpleFrame);
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetFrameByName", (arguments, globalScope, triggerScope) -> {
				final String templateName = arguments.get(0).visit(StringJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("FrameSetAbsPoint", (arguments, globalScope, triggerScope) -> {
				final UIFrame frame = arguments.get(0).visit(ObjectJassValueVisitor.<UIFrame>getInstance());
				final FramePoint framePoint = arguments.get(1).visit(ObjectJassValueVisitor.<FramePoint>getInstance());
				final double x = arguments.get(2).visit(RealJassValueVisitor.getInstance());
				final double y = arguments.get(3).visit(RealJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("FrameSetPoint", (arguments, globalScope, triggerScope) -> {
				final UIFrame frame = arguments.get(0).visit(ObjectJassValueVisitor.<UIFrame>getInstance());
				final FramePoint framePoint = arguments.get(1).visit(ObjectJassValueVisitor.<FramePoint>getInstance());
				final UIFrame otherFrame = arguments.get(2).visit(ObjectJassValueVisitor.<UIFrame>getInstance());
				final FramePoint otherPoint = arguments.get(3).visit(ObjectJassValueVisitor.<FramePoint>getInstance());
				final double x = arguments.get(2).visit(RealJassValueVisitor.getInstance());
				final double y = arguments.get(3).visit(RealJassValueVisitor.getInstance());

				frame.addSetPoint(new SetPoint(framePoint, otherFrame, otherPoint, GameUI.convertX(uiViewport, (float) x), GameUI.convertY(uiViewport, (float) y)));
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("FrameSetText", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("FrameSetTextColor", (arguments, globalScope, triggerScope) -> {
				final StringFrame frame = arguments.get(0).visit(ObjectJassValueVisitor.<StringFrame>getInstance());
				final int colorInt = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
				frame.setColor(new Color(colorInt));
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("ConvertColor", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("FramePositionBounds", (arguments, globalScope, triggerScope) -> {
				final UIFrame frame = arguments.get(0).visit(ObjectJassValueVisitor.<UIFrame>getInstance());
				frame.positionBounds(JUIEnvironment.this.gameUI, uiViewport);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SkinGetField", (arguments, globalScope, triggerScope) -> {
	...
	public static final class CommonEnvironment {
		...
		private CommonEnvironment(final JassProgramVisitor jassProgramVisitor, final DataSource dataSource,
			...
			jassProgramVisitor.getJassNativeManager().createNative("ConvertOrderButtonType", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("UnitId", (arguments, globalScope, triggerScope) -> {
				...
				final CUnitType unitTypeTmp = CommonEnvironment.this.simulation.getUnitData().getUnitTypeByJassLegacyName(idString);
				return new IntegerJassValue((unitTypeTmp == null) ? 0 : unitTypeTmp.getTypeId().getValue());
			});
			jassProgramVisitor.getJassNativeManager().createNative("UnitId2String", (arguments, globalScope, triggerScope) -> {
				final Integer id = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
				final War3ID war3id = new War3ID(id);
				final CUnitType unitTypeTmp = CommonEnvironment.this.simulation.getUnitData().getUnitType(war3id);
				return unitTypeTmp == null ? JassType.STRING.getNullValue() : new StringJassValue(unitTypeTmp.getLegacyName());
			});
			jassProgramVisitor.getJassNativeManager().createNative("AbilityId", (arguments, globalScope, triggerScope) -> {
				return new IntegerJassValue(0);
			});
			jassProgramVisitor.getJassNativeManager().createNative("AbilityId2String", (arguments, globalScope, triggerScope) -> {
				return new StringJassValue("");
			});
			jassProgramVisitor.getJassNativeManager().createNative("BlzGetUnitAbilityByIndex", (arguments, globalScope, triggerScope) -> {
				...
				return new HandleJassValue(abilityType, (whichAbilityIndex < abilities.size()) ? abilities.get(whichAbilityIndex) : null);
			});
			jassProgramVisitor.getJassNativeManager().createNative("WarsmashGetAbilityTypeId", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("WarsmashGetAbilityClassName", (arguments, globalScope, triggerScope) -> {
				final CAbility ability = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				return new StringJassValue(ability.getClass().getSimpleName());
			});
			jassProgramVisitor.getJassNativeManager().createNative("WarsmashGetRawcode2String", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetObjectName", (arguments, globalScope, triggerScope) -> {
				final Integer id = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
				final War3ID war3id = new War3ID(id);
				final CUnitType unitTypeTmp = CommonEnvironment.this.simulation.getUnitData().getUnitType(war3id);
				if (unitTypeTmp != null) {
				...
				final MutableGameObject abilityEditorData = war3MapViewer.getAllObjectData().getAbilities().get(war3id);
				...
				final CDestructableType destructableTypeTmp = CommonEnvironment.this.simulation.getDestructableData().getUnitType(war3id);
			...
			// Timer API
			//
			jassProgramVisitor.getJassNativeManager().createNative("CreateTimer", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(timerType, new CTimerJass(globalScope, CommonEnvironment.this.simulation.getHandleIdAllocator().createId()));
			});
			jassProgramVisitor.getJassNativeManager().createNative("DestroyTimer", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("TimerStart", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("TimerGetElapsed", (arguments, globalScope, triggerScope) -> {
				final CTimerJass timer = arguments.get(0).visit(ObjectJassValueVisitor.<CTimerJass>getInstance());
				return new RealJassValue(timer.getElapsed(CommonEnvironment.this.simulation));
			});
			jassProgramVisitor.getJassNativeManager().createNative("TimerGetRemaining", (arguments, globalScope, triggerScope) -> {
				final CTimerJass timer = arguments.get(0).visit(ObjectJassValueVisitor.<CTimerJass>getInstance());
				return new RealJassValue(timer.getRemaining(CommonEnvironment.this.simulation));
			});
			jassProgramVisitor.getJassNativeManager().createNative("TimerGetTimeout", (arguments, globalScope, triggerScope) -> {
				final CTimerJass timer = arguments.get(0).visit(ObjectJassValueVisitor.<CTimerJass>getInstance());
				return new RealJassValue(timer.getTimeoutTime());
			});
			jassProgramVisitor.getJassNativeManager().createNative("PauseTimer", (arguments, globalScope, triggerScope) -> {
				final CTimerJass timer = arguments.get(0).visit(ObjectJassValueVisitor.<CTimerJass>getInstance());
				timer.pause(CommonEnvironment.this.simulation);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("ResumeTimer", (arguments, globalScope, triggerScope) -> {
				final CTimerJass timer = arguments.get(0).visit(ObjectJassValueVisitor.<CTimerJass>getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("DestroyGroup", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("GroupAddUnit", (arguments, globalScope, triggerScope) -> {
				final List<CUnit> group = arguments.get(0).visit(ObjectJassValueVisitor.<List<CUnit>>getInstance());
				final CUnit whichUnit = arguments.get(1).visit(ObjectJassValueVisitor.<CUnit>getInstance());
				group.add(whichUnit);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("GroupRemoveUnit", (arguments, globalScope, triggerScope) -> {
				final List<CUnit> group = arguments.get(0).visit(ObjectJassValueVisitor.<List<CUnit>>getInstance());
				final CUnit whichUnit = arguments.get(1).visit(ObjectJassValueVisitor.<CUnit>getInstance());
				group.remove(whichUnit);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("GroupClear", (arguments, globalScope, triggerScope) -> {
				final List<CUnit> group = arguments.get(0).visit(ObjectJassValueVisitor.<List<CUnit>>getInstance());
				group.clear();
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("GroupEnumUnitsOfType", (arguments, globalScope, triggerScope) -> {
				final List<CUnit> group = arguments.get(0).visit(ObjectJassValueVisitor.<List<CUnit>>getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("GroupEnumUnitsOfPlayer", (arguments, globalScope, triggerScope) -> {
				final List<CUnit> group = arguments.get(0).visit(ObjectJassValueVisitor.<List<CUnit>>getInstance());
				final CPlayerJass player = arguments.get(1).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
				final TriggerBooleanExpression filter = nullable(arguments, 2, ObjectJassValueVisitor.<TriggerBooleanExpression>getInstance());
				for (final CUnit unit : CommonEnvironment.this.simulation.getUnits()) {
			...
			jassProgramVisitor.getJassNativeManager().createNative("IssuePointOrderLoc", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				if (whichUnit == null) {
					return BooleanJassValue.FALSE;
				}
				final String orderString = arguments.get(1).visit(StringJassValueVisitor.getInstance());
				final Point2D.Double whichLocation = arguments.get(2).visit(ObjectJassValueVisitor.<Point2D.Double>getInstance());
				final CPlayerUnitOrderExecutor defaultPlayerUnitOrderExecutor = CommonEnvironment.this.simulation.getDefaultPlayerUnitOrderExecutor(whichUnit.getPlayerIndex());
				...
				AbilityPointTarget targetAsPoint = new AbilityPointTarget((float) whichLocation.x, (float) whichLocation.y);
				for (final CAbility ability : whichUnit.getAbilities()) {
					...
					if (activationReceiver.isOk()) {
						...
						ability.checkCanTarget(CommonEnvironment.this.simulation, whichUnit, orderId, targetAsPoint, targetReceiver.reset());
				...
				if (abilityHandleId != 0) {
					defaultPlayerUnitOrderExecutor.issuePointOrder(whichUnit.getHandleId(), abilityHandleId, orderId, targetAsPoint.x, targetAsPoint.y, false);
				}
				return BooleanJassValue.of(abilityHandleId != 0);
			});
			jassProgramVisitor.getJassNativeManager().createNative("IssuePointOrderById", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				if (whichUnit == null) {
					return BooleanJassValue.FALSE;
				}
				...
				final BooleanAbilityActivationReceiver activationReceiver = BooleanAbilityActivationReceiver.INSTANCE;
				int abilityHandleId = 0;
				AbilityPointTarget targetAsPoint = new AbilityPointTarget((float) whichLocationX, (float) whichLocationY);
				for (final CAbility ability : whichUnit.getAbilities()) {
					ability.checkCanUse(CommonEnvironment.this.simulation, whichUnit, orderId, activationReceiver);
					if (activationReceiver.isOk()) {
						final PointAbilityTargetCheckReceiver targetReceiver = PointAbilityTargetCheckReceiver.INSTANCE;
			...
			jassProgramVisitor.getJassNativeManager().createNative("IssueTargetOrder", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				if (whichUnit == null) {
					return BooleanJassValue.FALSE;
				}
				...
				for (final CAbility ability : whichUnit.getAbilities()) {
					...
					if (activationReceiver.isOk()) {
						...
						ability.checkCanTarget(CommonEnvironment.this.simulation, whichUnit, orderId, whichTarget, targetReceiver.reset());
						if (targetReceiver.getTarget() != null) {
				...
				if (abilityHandleId != 0) {
					defaultPlayerUnitOrderExecutor.issueTargetOrder(whichUnit.getHandleId(), abilityHandleId, orderId, whichTarget.getHandleId(), false);
				}
				return BooleanJassValue.of(abilityHandleId != 0);
			});
			jassProgramVisitor.getJassNativeManager().createNative("IssueTargetOrderById", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				if (whichUnit == null) {
					return BooleanJassValue.FALSE;
				}
			...
			jassProgramVisitor.getJassNativeManager().createNative("IssueImmediateOrder", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final String orderString = arguments.get(1).visit(StringJassValueVisitor.getInstance());
				final CPlayerUnitOrderExecutor defaultPlayerUnitOrderExecutor = CommonEnvironment.this.simulation.getDefaultPlayerUnitOrderExecutor(whichUnit.getPlayerIndex());
				final BooleanAbilityActivationReceiver activationReceiver = BooleanAbilityActivationReceiver.INSTANCE;
				...
				for (final CAbility ability : whichUnit.getAbilities()) {
					ability.checkCanUse(CommonEnvironment.this.simulation, whichUnit, orderId, activationReceiver);
					if (activationReceiver.isOk()) {
						final BooleanAbilityTargetCheckReceiver<Void> targetReceiver = BooleanAbilityTargetCheckReceiver.<Void>getInstance();
						ability.checkCanTargetNoTarget(CommonEnvironment.this.simulation, whichUnit, orderId, targetReceiver.reset());
						if (targetReceiver.isTargetable()) {
							abilityHandleId = ability.getHandleId();
						}
					}
				}
				defaultPlayerUnitOrderExecutor.issueImmediateOrder(whichUnit.getHandleId(), abilityHandleId, orderId, false);
				return BooleanJassValue.of(abilityHandleId != 0);
			});
			jassProgramVisitor.getJassNativeManager().createNative("IssueImmediateOrderById", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final int orderId = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
				final CPlayerUnitOrderExecutor defaultPlayerUnitOrderExecutor = CommonEnvironment.this.simulation.getDefaultPlayerUnitOrderExecutor(whichUnit.getPlayerIndex());
				final BooleanAbilityActivationReceiver activationReceiver = BooleanAbilityActivationReceiver.INSTANCE;
			...
			jassProgramVisitor.getJassNativeManager().createNative("UnitDamageTarget", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("GroupEnumUnitsOfTypeCounted", (arguments, globalScope, triggerScope) -> {
				final List<CUnit> group = arguments.get(0).visit(ObjectJassValueVisitor.<List<CUnit>>getInstance());
				final String unitname = arguments.get(1).visit(StringJassValueVisitor.getInstance());
				final TriggerBooleanExpression filter = arguments.get(2).visit(ObjectJassValueVisitor.<TriggerBooleanExpression>getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("GroupEnumUnitsInRect", (arguments, globalScope, triggerScope) -> {
				final List<CUnit> group = arguments.get(0).visit(ObjectJassValueVisitor.<List<CUnit>>getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("GroupEnumUnitsInRectCounted", (arguments, globalScope, triggerScope) -> {
				final List<CUnit> group = arguments.get(0).visit(ObjectJassValueVisitor.<List<CUnit>>getInstance());
				final Rectangle rect = arguments.get(1).visit(ObjectJassValueVisitor.<Rectangle>getInstance());
				...
				CommonEnvironment.this.simulation.getWorldCollision().enumUnitsInRect(rect,
					new CUnitEnumFunction() {
						...
						public boolean call(final CUnit unit) {
							if (filter.evaluate(globalScope, CommonTriggerExecutionScope.filterScope(triggerScope, unit))) {
								// TODO the trigger scope for evaluation here might need to be a clean one?
								group.add(unit);
								this.count++;
			...
			jassProgramVisitor.getJassNativeManager().createNative("GroupEnumUnitsInRange", (arguments, globalScope, triggerScope) -> {
				final List<CUnit> group = arguments.get(0).visit(ObjectJassValueVisitor.<List<CUnit>>getInstance());
				...
				final TriggerBooleanExpression filter = nullable(arguments, 4, ObjectJassValueVisitor.<TriggerBooleanExpression>getInstance());
				CommonEnvironment.this.simulation.getWorldCollision().enumUnitsInRect(tempRect.set(x - radius, y - radius, radius * 2, radius * 2), (unit) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("GroupEnumUnitsInRangeOfLoc", (arguments, globalScope, triggerScope) -> {
				final List<CUnit> group = arguments.get(0).visit(ObjectJassValueVisitor.<List<CUnit>>getInstance());
				final Point2D.Double whichLocation = arguments.get(1).visit(ObjectJassValueVisitor.<Point2D.Double>getInstance());
				...
				final TriggerBooleanExpression filter = nullable(arguments, 3, ObjectJassValueVisitor.<TriggerBooleanExpression>getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("GroupEnumUnitsInRangeCounted", (arguments, globalScope, triggerScope) -> {
				final List<CUnit> group = arguments.get(0).visit(ObjectJassValueVisitor.<List<CUnit>>getInstance());
				final float x = arguments.get(1).visit(RealJassValueVisitor.getInstance()).floatValue();
				final float y = arguments.get(2).visit(RealJassValueVisitor.getInstance()).floatValue();
				final float radius = arguments.get(3).visit(RealJassValueVisitor.getInstance()).floatValue();
				final TriggerBooleanExpression filter = arguments.get(4).visit(ObjectJassValueVisitor.<TriggerBooleanExpression>getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("GroupEnumUnitsInRangeOfLocCounted", (arguments, globalScope, triggerScope) -> {
				final List<CUnit> group = arguments.get(0).visit(ObjectJassValueVisitor.<List<CUnit>>getInstance());
				final Point2D.Double whichLocation = arguments.get(1).visit(ObjectJassValueVisitor.<Point2D.Double>getInstance());
				final float x = (float) whichLocation.x;
				final float y = (float) whichLocation.y;
				final float radius = arguments.get(2).visit(RealJassValueVisitor.getInstance()).floatValue();
				final TriggerBooleanExpression filter = arguments.get(3).visit(ObjectJassValueVisitor.<TriggerBooleanExpression>getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("GroupEnumUnitsSelected", (arguments, globalScope, triggerScope) -> {
				final List<CUnit> group = arguments.get(0).visit(ObjectJassValueVisitor.<List<CUnit>>getInstance());
				final CPlayerJass whyichPlayer = arguments.get(1).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
				final TriggerBooleanExpression filter = arguments.get(2).visit(ObjectJassValueVisitor.<TriggerBooleanExpression>getInstance());
				throw new UnsupportedOperationException("GroupEnumUnitsSelected not supported yet.");
			});
			jassProgramVisitor.getJassNativeManager().createNative("GroupImmediateOrder", (arguments, globalScope, triggerScope) -> {
				final List<CUnit> group = arguments.get(0).visit(ObjectJassValueVisitor.<List<CUnit>>getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("GroupImmediateOrderById", (arguments, globalScope, triggerScope) -> {
				final List<CUnit> group = arguments.get(0).visit(ObjectJassValueVisitor.<List<CUnit>>getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("GroupPointOrder", (arguments, globalScope, triggerScope) -> {
				final List<CUnit> group = arguments.get(0).visit(ObjectJassValueVisitor.<List<CUnit>>getInstance());
				final String order = arguments.get(1).visit(StringJassValueVisitor.getInstance());
				final Double x = arguments.get(2).visit(RealJassValueVisitor.getInstance());
				final Double y = arguments.get(3).visit(RealJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("GroupPointOrderLoc", (arguments, globalScope, triggerScope) -> {
				final List<CUnit> group = arguments.get(0).visit(ObjectJassValueVisitor.<List<CUnit>>getInstance());
				final String order = arguments.get(1).visit(StringJassValueVisitor.getInstance());
				final Point2D.Double whichLocation = arguments.get(2).visit(ObjectJassValueVisitor.<Point2D.Double>getInstance());
				final AbilityPointTarget target = new AbilityPointTarget((float) whichLocation.x, (float) whichLocation.y);
				final int orderId = OrderIdUtils.getOrderId(order);
				boolean success = true;
				for (final CUnit unit : group) {
					success &= unit.order(CommonEnvironment.this.simulation, orderId, target);
			...
			jassProgramVisitor.getJassNativeManager().createNative("GroupPointOrderById", (arguments, globalScope, triggerScope) -> {
				final List<CUnit> group = arguments.get(0).visit(ObjectJassValueVisitor.<List<CUnit>>getInstance());
				final int orderId = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
				final Double x = arguments.get(2).visit(RealJassValueVisitor.getInstance());
				final Double y = arguments.get(3).visit(RealJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("GroupPointOrderByIdLoc", (arguments, globalScope, triggerScope) -> {
				final List<CUnit> group = arguments.get(0).visit(ObjectJassValueVisitor.<List<CUnit>>getInstance());
				final int orderId = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
				final Point2D.Double whichLocation = arguments.get(2).visit(ObjectJassValueVisitor.<Point2D.Double>getInstance());
				final AbilityPointTarget target = new AbilityPointTarget((float) whichLocation.x, (float) whichLocation.y);
			...
			jassProgramVisitor.getJassNativeManager().createNative("GroupTargetOrder", (arguments, globalScope, triggerScope) -> {
				final List<CUnit> group = arguments.get(0).visit(ObjectJassValueVisitor.<List<CUnit>>getInstance());
				final String order = arguments.get(1).visit(StringJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("GroupTargetOrderById", (arguments, globalScope, triggerScope) -> {
				final List<CUnit> group = arguments.get(0).visit(ObjectJassValueVisitor.<List<CUnit>>getInstance());
				final int orderId = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
				final CWidget target = arguments.get(2).visit(ObjectJassValueVisitor.<CWidget>getInstance());
				boolean success = true;
			...
			jassProgramVisitor.getJassNativeManager().createNative("ForGroup", (arguments, globalScope, triggerScope) -> {
				...
				try {
					for (final CUnit unit : group) {
						callback.call(Collections.emptyList(), globalScope, CommonTriggerExecutionScope.enumScope(triggerScope, unit));
					}
				}
				catch (final Exception e) {
			...
			jassProgramVisitor.getJassNativeManager().createNative("FirstOfGroup", (arguments, globalScope, triggerScope) -> {
				final List<CUnit> group = arguments.get(0).visit(ObjectJassValueVisitor.<List<CUnit>>getInstance());
				if (group.isEmpty()) {
			...
			// Force API
			//
			jassProgramVisitor.getJassNativeManager().createNative("CreateForce", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(forceType, new ArrayList<CPlayerJass>());
			});
			jassProgramVisitor.getJassNativeManager().createNative("DestroyForce", (arguments, globalScope, triggerScope) -> {
				final List<CPlayerJass> force = arguments.get(0).visit(ObjectJassValueVisitor.<List<CPlayerJass>>getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("ForceAddPlayer", (arguments, globalScope, triggerScope) -> {
				final List<CPlayerJass> force = arguments.get(0).visit(ObjectJassValueVisitor.<List<CPlayerJass>>getInstance());
				final CPlayerJass player = arguments.get(1).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
				if (force == null) {
			...
			jassProgramVisitor.getJassNativeManager().createNative("ForceRemovePlayer", (arguments, globalScope, triggerScope) -> {
				final List<CPlayerJass> force = arguments.get(0).visit(ObjectJassValueVisitor.<List<CPlayerJass>>getInstance());
				final CPlayerJass player = arguments.get(1).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
				force.remove(player);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("ForceClear", (arguments, globalScope, triggerScope) -> {
				final List<CPlayerJass> force = arguments.get(0).visit(ObjectJassValueVisitor.<List<CPlayerJass>>getInstance());
				force.clear();
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("ForceEnumPlayers", (arguments, globalScope, triggerScope) -> {
				final List<CPlayerJass> force = arguments.get(0).visit(ObjectJassValueVisitor.<List<CPlayerJass>>getInstance());
				final TriggerBooleanExpression filter = nullable(arguments, 1, ObjectJassValueVisitor.<TriggerBooleanExpression>getInstance());
				for (int i = 0; i < WarsmashConstants.MAX_PLAYERS; i++) {
					final CPlayerJass jassPlayer = CommonEnvironment.this.simulation.getPlayer(i);
					if ((filter == null) || filter.evaluate(globalScope, CommonTriggerExecutionScope.filterScope(triggerScope, jassPlayer))) {
						force.add(jassPlayer);
					}
				}
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("ForceEnumPlayersCounted", (arguments, globalScope, triggerScope) -> {
				final List<CPlayerJass> force = arguments.get(0).visit(ObjectJassValueVisitor.<List<CPlayerJass>>getInstance());
				final TriggerBooleanExpression filter = arguments.get(1).visit(ObjectJassValueVisitor.<TriggerBooleanExpression>getInstance());
				...
				for (int i = 0; (i < WarsmashConstants.MAX_PLAYERS) && (count < countLimit); i++) {
					final CPlayerJass jassPlayer = CommonEnvironment.this.simulation.getPlayer(i);
					if (filter.evaluate(globalScope, CommonTriggerExecutionScope.filterScope(triggerScope, jassPlayer))) {
						force.add(jassPlayer);
						count++;
					}
				}
			...
			jassProgramVisitor.getJassNativeManager().createNative("ForceEnumAllies", (arguments, globalScope, triggerScope) -> {
				final List<CPlayerJass> force = arguments.get(0).visit(ObjectJassValueVisitor.<List<CPlayerJass>>getInstance());
				final CPlayerJass player = arguments.get(1).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
				final TriggerBooleanExpression filter = nullable(arguments, 2, ObjectJassValueVisitor.<TriggerBooleanExpression>getInstance());
				for (int i = 0; i < WarsmashConstants.MAX_PLAYERS; i++) {
			...
			jassProgramVisitor.getJassNativeManager().createNative("ForceEnumEnemies", (arguments, globalScope, triggerScope) -> {
				final List<CPlayerJass> force = arguments.get(0).visit(ObjectJassValueVisitor.<List<CPlayerJass>>getInstance());
				final CPlayerJass player = arguments.get(1).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
				final TriggerBooleanExpression filter = nullable(arguments, 2, ObjectJassValueVisitor.<TriggerBooleanExpression>getInstance());
				for (int i = 0; i < WarsmashConstants.MAX_PLAYERS; i++) {
			...
			jassProgramVisitor.getJassNativeManager().createNative("ForForce", (arguments, globalScope, triggerScope) -> {
				final List<CPlayerJass> force = arguments.get(0).visit(ObjectJassValueVisitor.<List<CPlayerJass>>getInstance());
				final JassFunction callback = arguments.get(1).visit(JassFunctionJassValueVisitor.getInstance());
				try {
					for (final CPlayerJass player : force) {
						callback.call(Collections.<JassValue>emptyList(), globalScope, CommonTriggerExecutionScope.enumScope(triggerScope, player));
					}
				}
				catch (final Exception e) {
			...
			jassProgramVisitor.getJassNativeManager().createNative("RectFromLoc", (arguments, globalScope, triggerScope) -> {
				final Point2D.Double min = arguments.get(0).visit(ObjectJassValueVisitor.<Point2D.Double>getInstance());
				final Point2D.Double max = arguments.get(1).visit(ObjectJassValueVisitor.<Point2D.Double>getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("RemoveRect", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("SetRect", (arguments, globalScope, triggerScope) -> {
				final Rectangle rect = arguments.get(0).visit(ObjectJassValueVisitor.<Rectangle>getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("SetRectFromLoc", (arguments, globalScope, triggerScope) -> {
				final Rectangle rect = arguments.get(0).visit(ObjectJassValueVisitor.<Rectangle>getInstance());
				final Point2D.Double min = arguments.get(1).visit(ObjectJassValueVisitor.<Point2D.Double>getInstance());
				final Point2D.Double max = arguments.get(2).visit(ObjectJassValueVisitor.<Point2D.Double>getInstance());
				final float minx = (float) min.x;
				final float miny = (float) min.y;
				final float maxx = (float) max.x;
				final float maxy = (float) max.y;
			...
			jassProgramVisitor.getJassNativeManager().createNative("MoveRectTo", (arguments, globalScope, triggerScope) -> {
				final Rectangle rect = arguments.get(0).visit(ObjectJassValueVisitor.<Rectangle>getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("MoveRectToLoc", (arguments, globalScope, triggerScope) -> {
				final Rectangle rect = arguments.get(0).visit(ObjectJassValueVisitor.<Rectangle>getInstance());
				final Point2D.Double newCenterLoc = arguments.get(1).visit(ObjectJassValueVisitor.<Point2D.Double>getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetRectMinX", (arguments, globalScope, triggerScope) -> {
				final Rectangle rect = arguments.get(0).visit(ObjectJassValueVisitor.<Rectangle>getInstance());
				return new RealJassValue(rect.getX());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetRectMinY", (arguments, globalScope, triggerScope) -> {
				final Rectangle rect = arguments.get(0).visit(ObjectJassValueVisitor.<Rectangle>getInstance());
				return new RealJassValue(rect.getY());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetRectMaxX", (arguments, globalScope, triggerScope) -> {
				final Rectangle rect = arguments.get(0).visit(ObjectJassValueVisitor.<Rectangle>getInstance());
				return new RealJassValue(rect.getX() + rect.getWidth());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetRectMaxY", (arguments, globalScope, triggerScope) -> {
				final Rectangle rect = arguments.get(0).visit(ObjectJassValueVisitor.<Rectangle>getInstance());
				return new RealJassValue(rect.getY() + rect.getHeight());
			});
			jassProgramVisitor.getJassNativeManager().createNative("CreateRegion", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(regionType, new CRegion());
			});
			jassProgramVisitor.getJassNativeManager().createNative("RemoveRegion", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("RegionAddRect", (arguments, globalScope, triggerScope) -> {
				final CRegion region = arguments.get(0).visit(ObjectJassValueVisitor.<CRegion>getInstance());
				final Rectangle rect = arguments.get(1).visit(ObjectJassValueVisitor.<Rectangle>getInstance());
				region.addRect(rect, CommonEnvironment.this.simulation.getRegionManager());
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("RegionClearRect", (arguments, globalScope, triggerScope) -> {
				final CRegion region = arguments.get(0).visit(ObjectJassValueVisitor.<CRegion>getInstance());
				final Rectangle rect = arguments.get(1).visit(ObjectJassValueVisitor.<Rectangle>getInstance());
				region.clearRect(rect, CommonEnvironment.this.simulation.getRegionManager());
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("RegionAddCell", (arguments, globalScope, triggerScope) -> {
				final CRegion region = arguments.get(0).visit(ObjectJassValueVisitor.<CRegion>getInstance());
				final float x = arguments.get(1).visit(RealJassValueVisitor.getInstance()).floatValue();
				final float y = arguments.get(2).visit(RealJassValueVisitor.getInstance()).floatValue();
			...
			jassProgramVisitor.getJassNativeManager().createNative("RegionAddCellAtLoc", (arguments, globalScope, triggerScope) -> {
				final CRegion region = arguments.get(0).visit(ObjectJassValueVisitor.<CRegion>getInstance());
				final Point2D.Double whichLocation = arguments.get(1).visit(ObjectJassValueVisitor.<Point2D.Double>getInstance());
				region.addCell((float) whichLocation.x, (float) whichLocation.y,CommonEnvironment.this.simulation.getRegionManager());
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("RegionClearCell", (arguments, globalScope, triggerScope) -> {
				final CRegion region = arguments.get(0).visit(ObjectJassValueVisitor.<CRegion>getInstance());
				final float x = arguments.get(1).visit(RealJassValueVisitor.getInstance()).floatValue();
				final float y = arguments.get(2).visit(RealJassValueVisitor.getInstance()).floatValue();
			...
			jassProgramVisitor.getJassNativeManager().createNative("RegionClearCellAtLoc", (arguments, globalScope, triggerScope) -> {
				final CRegion region = arguments.get(0).visit(ObjectJassValueVisitor.<CRegion>getInstance());
				final Point2D.Double whichLocation = arguments.get(1).visit(ObjectJassValueVisitor.<Point2D.Double>getInstance());
				region.clearCell((float) whichLocation.x, (float) whichLocation.y, CommonEnvironment.this.simulation.getRegionManager());
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("Location", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("RemoveLocation", (arguments, globalScope, triggerScope) -> {
				final Point2D.Double whichLocation = arguments.get(0).visit(ObjectJassValueVisitor.<Point2D.Double>getInstance());
				System.err.println("RemoveRect called but in Java we don't have a destructor, so we need to unregister later when that is implemented");
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("MoveLocation", (arguments, globalScope, triggerScope) -> {
				final Point2D.Double whichLocation = arguments.get(0).visit(ObjectJassValueVisitor.<Point2D.Double>getInstance());
				final float x = arguments.get(1).visit(RealJassValueVisitor.getInstance()).floatValue();
				final float y = arguments.get(2).visit(RealJassValueVisitor.getInstance()).floatValue();
				whichLocation.x = x;
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetLocationX", (arguments, globalScope, triggerScope) -> {
				final Point2D.Double whichLocation = arguments.get(0).visit(ObjectJassValueVisitor.<Point2D.Double>getInstance());
				return new RealJassValue(whichLocation.x);
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetLocationY", (arguments, globalScope, triggerScope) -> {
				final Point2D.Double whichLocation = arguments.get(0).visit(ObjectJassValueVisitor.<Point2D.Double>getInstance());
				return new RealJassValue(whichLocation.y);
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetLocationZ", (arguments, globalScope, triggerScope) -> {
				final Point2D.Double whichLocation = arguments.get(0).visit(ObjectJassValueVisitor.<Point2D.Double>getInstance());
				return new RealJassValue(war3MapViewer.terrain.getGroundHeight((float) whichLocation.x, (float) whichLocation.y));
			});
			jassProgramVisitor.getJassNativeManager().createNative("IsUnitInRegion", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("IsPointInRegion", (arguments, globalScope, triggerScope) -> {
				final CRegion whichRegion = arguments.get(0).visit(ObjectJassValueVisitor.<CRegion>getInstance());
				final float x = arguments.get(1).visit(RealJassValueVisitor.getInstance()).floatValue();
				final float y = arguments.get(2).visit(RealJassValueVisitor.getInstance()).floatValue();
				return BooleanJassValue.of(whichRegion.contains(x, y, CommonEnvironment.this.simulation.getRegionManager()));
			});
			jassProgramVisitor.getJassNativeManager().createNative("IsLocationInRegion", (arguments, globalScope, triggerScope) -> {
				final CRegion whichRegion = arguments.get(0).visit(ObjectJassValueVisitor.<CRegion>getInstance());
				final Point2D.Double whichLocation = arguments.get(1).visit(ObjectJassValueVisitor.<Point2D.Double>getInstance());
				return BooleanJassValue.of(whichRegion.contains((float) whichLocation.x, (float) whichLocation.y, CommonEnvironment.this.simulation.getRegionManager()));
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetWorldBounds", (arguments, globalScope, triggerScope) -> {
				...
				final float worldMaxX = CommonEnvironment.this.simulation.getPathingGrid().getWorldX(CommonEnvironment.this.simulation.getPathingGrid().getWidth() - 1) + 16f;
				final float worldMaxY = CommonEnvironment.this.simulation.getPathingGrid().getWorldY(CommonEnvironment.this.simulation.getPathingGrid().getHeight() - 1) + 16f;
				return new HandleJassValue(rectType, new Rectangle(worldMinX, worldMinY, worldMaxX - worldMinX, worldMaxY - worldMinY));
			});
			// ============================================================================
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetFilterUnit", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(unitType, ((CommonTriggerExecutionScope) triggerScope).getFilterUnit());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetEnumUnit", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(unitType, ((CommonTriggerExecutionScope) triggerScope).getEnumUnit());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetFilterDestructable", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(destructableType, ((CommonTriggerExecutionScope) triggerScope).getFilterDestructable());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetEnumDestructable", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(destructableType, ((CommonTriggerExecutionScope) triggerScope).getEnumDestructable());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetFilterItem", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(itemType, ((CommonTriggerExecutionScope) triggerScope).getFilterItem());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetEnumItem", (arguments, globalScope, triggerScope) -> {
			...
			// ============================================================================
			jassProgramVisitor.getJassNativeManager().createNative("TriggerRegisterVariableEvent", (arguments, globalScope, triggerScope) -> {
				...
				final RemovableTriggerEvent event = globalScope.registerVariableEvent(trigger, varName, limitOp, limitval.doubleValue());
				return new HandleJassValue(eventType, event);
			});
			jassProgramVisitor.getJassNativeManager().createNative("TriggerRegisterTimerEvent", (arguments, globalScope, triggerScope) -> {
				final Trigger trigger = arguments.get(0).visit(ObjectJassValueVisitor.<Trigger>getInstance());
				final Double timeout = arguments.get(1).visit(RealJassValueVisitor.getInstance());
				final Boolean periodic = arguments.get(2).visit(BooleanJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("TriggerRegisterTimerExpireEvent", (arguments, globalScope, triggerScope) -> {
				final Trigger trigger = arguments.get(0).visit(ObjectJassValueVisitor.<Trigger>getInstance());
				final CTimerJass timer = arguments.get(1).visit(ObjectJassValueVisitor.<CTimerJass>getInstance());
				timer.addEvent(trigger);
				return new HandleJassValue(eventType, (RemovableTriggerEvent)() -> {
					timer.removeEvent(trigger);
				});
			});
			jassProgramVisitor.getJassNativeManager().createNative("TriggerRegisterGameStateEvent", (arguments, globalScope, triggerScope) -> {
				final Trigger trigger = arguments.get(0).visit(ObjectJassValueVisitor.<Trigger>getInstance());
				final CGameState whichState = arguments.get(1).visit(ObjectJassValueVisitor.<CGameState>getInstance());
				...
				return new HandleJassValue(eventType, CommonEnvironment.this.simulation.registerTimeOfDayEvent(globalScope, trigger, opcode, limitval.doubleValue()));
			});
			if (JassSettings.CONTINUE_EXECUTING_ON_ERROR) {
				jassProgramVisitor.getJassNativeManager().createNative("TriggerRegisterUnitStateEvent", (arguments, globalScope, triggerScope) -> {
					return new HandleJassValue(eventType, RemovableTriggerEvent.DO_NOTHING);
				});
			}
			jassProgramVisitor.getJassNativeManager().createNative("DialogCreate", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(dialogType, meleeUI.createScriptDialog(globalScope));
			});
			jassProgramVisitor.getJassNativeManager().createNative("DialogDestroy", (arguments, globalScope, triggerScope) -> {
				final CScriptDialog dialog = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				meleeUI.destroyDialog(dialog);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("DialogClear", (arguments, globalScope, triggerScope) -> {
				final CScriptDialog dialog = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				meleeUI.clearDialog(dialog);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("DialogSetMessage", (arguments, globalScope, triggerScope) -> {
				final CScriptDialog dialog = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("DialogAddButton", (arguments, globalScope, triggerScope) -> {
				final CScriptDialog dialog = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("DialogDisplay", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("SetUnitAcquireRange", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetClickedButton", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(buttonType, ((CommonTriggerExecutionScope) triggerScope).getClickedButton());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetClickedDialog", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(dialogType, ((CommonTriggerExecutionScope) triggerScope).getClickedDialog());
			});
			jassProgramVisitor.getJassNativeManager().createNative("TriggerRegisterDialogEvent", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("TriggerRegisterDialogButtonEvent", (arguments, globalScope, triggerScope) -> {
				final Trigger trigger = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final CScriptDialogButton dialogButton = arguments.get(1).visit(ObjectJassValueVisitor.getInstance());
				if (dialogButton == null) {
					return new HandleJassValue(eventType, RemovableTriggerEvent.DO_NOTHING);
				}
				return new HandleJassValue(eventType, dialogButton.addEvent(trigger));
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetEventGameState", (arguments, globalScope, triggerScope) -> {
				throw new UnsupportedOperationException("Not yet implemented: GetEventGameState");
			});
			jassProgramVisitor.getJassNativeManager().createNative("TriggerRegisterGameEvent", (arguments, globalScope, triggerScope) -> {
				final Trigger trigger = arguments.get(0).visit(ObjectJassValueVisitor.<Trigger>getInstance());
				final JassGameEventsWar3 gameEvent = arguments.get(1).visit(ObjectJassValueVisitor.getInstance());
				return new HandleJassValue(eventType, CommonEnvironment.this.simulation.registerGameEvent(globalScope, trigger, gameEvent));
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetWinningPlayer", (arguments, globalScope, triggerScope) -> {
				throw new UnsupportedOperationException("Not yet implemented: GetWinningPlayer");
			});
			jassProgramVisitor.getJassNativeManager().createNative("TriggerRegisterEnterRegion", (arguments, globalScope, triggerScope) -> {
				final Trigger trigger = arguments.get(0).visit(ObjectJassValueVisitor.<Trigger>getInstance());
				final CRegion region = arguments.get(1).visit(ObjectJassValueVisitor.<CRegion>getInstance());
				final TriggerBooleanExpression boolexpr = nullable(arguments, 2, ObjectJassValueVisitor.<TriggerBooleanExpression>getInstance());
				return new HandleJassValue(eventType, region.add(new CRegionTriggerEnter(globalScope, trigger, boolexpr)));
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetTriggeringRegion", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(unitType, ((CommonTriggerExecutionScope) triggerScope).getEnteringUnit());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetEnteringUnit", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(unitType, ((CommonTriggerExecutionScope) triggerScope).getEnteringUnit());
			});
			jassProgramVisitor.getJassNativeManager().createNative("TriggerRegisterLeaveRegion", (arguments, globalScope, triggerScope) -> {
				final Trigger trigger = arguments.get(0).visit(ObjectJassValueVisitor.<Trigger>getInstance());
					final CRegion region = arguments.get(1).visit(ObjectJassValueVisitor.<CRegion>getInstance());
					final TriggerBooleanExpression boolexpr = nullable(arguments, 2, ObjectJassValueVisitor.<TriggerBooleanExpression>getInstance());
					return new HandleJassValue(eventType, region.add(new CRegionTriggerLeave(globalScope, trigger, boolexpr)));
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetLeavingUnit", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(unitType, ((CommonTriggerExecutionScope) triggerScope).getLeavingUnit());
			});
			jassProgramVisitor.getJassNativeManager().createNative("TriggerRegisterTrackableHitEvent", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("TriggerRegisterTrackableTrackEvent", (arguments, globalScope, triggerScope) -> {
				throw new UnsupportedOperationException("TriggerRegisterTrackableTrackEvent not yet implemented ???");
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetTriggeringTrackable", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetTournamentFinishSoonTimeRemaining", (arguments, globalScope, triggerScope) -> {
				throw new UnsupportedOperationException("GetTournamentFinishSoonTimeRemaining not yet implemented ???");
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetTournamentFinishNowRule", (arguments, globalScope, triggerScope) -> {
				throw new UnsupportedOperationException("GetTournamentFinishNowRule not yet implemented ???");
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetTournamentFinishNowPlayer", (arguments, globalScope, triggerScope) -> {
				throw new UnsupportedOperationException("GetTournamentFinishNowPlayer not yet implemented ???");
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetTournamentScore", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("TriggerRegisterPlayerEvent", (arguments, globalScope, triggerScope) -> {
				...
				final JassGameEventsWar3 whichPlayerEvent = arguments.get(2).visit(ObjectJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetCameraBoundMinX", (arguments, globalScope, triggerScope) -> {
				return new RealJassValue(meleeUI.getCameraManager().getCameraBounds().getX());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetCameraBoundMinY", (arguments, globalScope, triggerScope) -> {
				return new RealJassValue(meleeUI.getCameraManager().getCameraBounds().getY());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetCameraBoundMaxX", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetCameraBoundMaxY", (arguments, globalScope, triggerScope) -> {
				final Rectangle cameraBounds = meleeUI.getCameraManager().getCameraBounds();
				return new RealJassValue(cameraBounds.getY() + cameraBounds.getHeight());
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetCameraBounds", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("SetDayNightModels", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("NewSoundEnvironment", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("CreateMIDISound", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetFloatGameState", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetIntegerGameState", (arguments, globalScope, triggerScope) -> {
				final CGameState gameState = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				switch (gameState) {
				case DISCONNECTED:
			...
			jassProgramVisitor.getJassNativeManager().createNative("SetFloatGameState", (arguments, globalScope, triggerScope) -> {
				final CGameState gameState = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("StartSound", (arguments, globalScope, triggerScope) -> {
				final CSound soundHandle = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				soundHandle.start();
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetMapMusic", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("PlayMusic", (arguments, globalScope, triggerScope) -> {
				final String musicName = arguments.get(0).visit(StringJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("CreateItem", (arguments, globalScope, triggerScope) -> {
				final int rawcode = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
				...
				return new HandleJassValue(itemType, CommonEnvironment.this.simulation.createItem(new War3ID(rawcode), (float) x, (float) y));
			});
			jassProgramVisitor.getJassNativeManager().createNative("UnitAddItemById", (arguments, globalScope, triggerScope) -> {
				final CUnit unit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("UnitAddItemToSlotById", (arguments, globalScope, triggerScope) -> {
				final CUnit unit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final int rawcode = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("ChooseRandomItem", (arguments, globalScope, triggerScope) -> {
				final int level = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
				final War3ID randomItemId = CommonEnvironment.this.simulation.getItemData().chooseRandomItem(level, CommonEnvironment.this.simulation.getSeededRandom());
				return new IntegerJassValue(randomItemId == null ? 0 : randomItemId.getValue());
			});
			jassProgramVisitor.getJassNativeManager().createNative("ChooseRandomItemEx", (arguments, globalScope, triggerScope) -> {
				...
				final War3ID randomItemId = CommonEnvironment.this.simulation.getItemData().chooseRandomItem(whichType, level, CommonEnvironment.this.simulation.getSeededRandom());
				return new IntegerJassValue(randomItemId == null ? 0 : randomItemId.getValue());
			});
			jassProgramVisitor.getJassNativeManager().createNative("CreateDestructable", (arguments, globalScope, triggerScope) -> {
				final int rawcode = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
				final float x = arguments.get(1).visit(RealJassValueVisitor.getInstance()).floatValue();
				final float y = arguments.get(2).visit(RealJassValueVisitor.getInstance()).floatValue();
				...
				return new HandleJassValue(destructableType, CommonEnvironment.this.simulation.createDestructable(new War3ID(rawcode), x, y, facing, scale, variation));
			});
			jassProgramVisitor.getJassNativeManager().createNative("BlzCreateDestructableWithSkin", (arguments, globalScope, triggerScope) -> {
				...
				if (skinId != rawcode) {
					// throw new IllegalStateException("Our engine does not support DestructableSkinID != DestructableID (skinId="+ new War3ID(skinId) + ", destId=" + new War3ID(rawcode) + ")");
					rawcode = skinId;
				}
				return new HandleJassValue(destructableType, CommonEnvironment.this.simulation.createDestructable(new War3ID(rawcode), x, y, facing, scale, variation));
			});
			jassProgramVisitor.getJassNativeManager().createNative("CreateDestructableZ", (arguments, globalScope, triggerScope) -> {
				final int rawcode = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
				final float x = arguments.get(1).visit(RealJassValueVisitor.getInstance()).floatValue();
				final float y = arguments.get(2).visit(RealJassValueVisitor.getInstance()).floatValue();
				...
				return new HandleJassValue(destructableType, CommonEnvironment.this.simulation.createDestructableZ(new War3ID(rawcode), x, y, z, facing, scale, variation));
			});
			jassProgramVisitor.getJassNativeManager().createNative("KillDestructable", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("CreateUnit", (arguments, globalScope, triggerScope) -> {
				...
				final CUnit newUnit = CommonEnvironment.this.simulation.createUnitSimple(rawcodeId, player.getId(), (float) x, (float) y, (float) facing);
				return new HandleJassValue(unitType, newUnit);
			});
			jassProgramVisitor.getJassNativeManager().createNative("BlzCreateUnitWithSkin", (arguments, globalScope, triggerScope) -> {
				final CPlayer player = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				...
				final CUnit newUnit = CommonEnvironment.this.simulation.createUnitSimple(rawcodeId, player.getId(), (float) x, (float) y, (float) facing);
				if (skinId != rawcode) {
					// throw new IllegalStateException("Our engine does not support UnitSkinID != UnitID (skinId=" + new War3ID(skinId) + ", unitId=" + new War3ID(rawcode) + ")");
					rawcode = skinId;
				}
				return new HandleJassValue(unitType, newUnit);
			});
			jassProgramVisitor.getJassNativeManager().createNative("CreateUnitAtLoc", (arguments, globalScope, triggerScope) -> {
				final CPlayer player = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final int rawcode = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
				...
				final CUnit newUnit = CommonEnvironment.this.simulation.createUnitSimple(rawcodeId, player.getId(), x, y, facing);
				return new HandleJassValue(unitType, newUnit);
			});
			jassProgramVisitor.getJassNativeManager().createNative("CreateBlightedGoldmine", (arguments, globalScope, triggerScope) -> {
				...
				final CUnit blightedMine = CommonEnvironment.this.simulation.createUnitSimple(blightedMineRawcode, player.getId(), (float) x, (float) y, (float) facing);
				final CUnit goldMine = CommonEnvironment.this.simulation.createUnitSimple(goldMineRawcode, WarsmashConstants.MAX_PLAYERS - 1, (float) x, (float) y, (float) facing);
			...
			jassProgramVisitor.getJassNativeManager().createNative("SetUnitColor", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("SetUnitOwner", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("SetResourceAmount", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final int resourceAmount = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
				whichUnit.setGold(resourceAmount);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetResourceAmount", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				return new IntegerJassValue(whichUnit.getGold());
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetUnitState", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = nullable(arguments, 0, ObjectJassValueVisitor.getInstance());
				...
				if (whichUnit != null) {
					...
					System.err.println("got SetUnitState(null," + whichUnitState + "," + value + ")  call (skipping because unit is null)");
				}
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetUnitState", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final CUnitState whichUnitState = arguments.get(1).visit(ObjectJassValueVisitor.getInstance());
				if (whichUnit == null) {
			...
			jassProgramVisitor.getJassNativeManager().createNative("SetHeroLevel", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final int level = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("IsUnitType", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetPlayerState", (arguments, globalScope, triggerScope) -> {
				final CPlayer player = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final CPlayerState whichPlayerState = arguments.get(1).visit(ObjectJassValueVisitor.getInstance());
				return new IntegerJassValue(player.getPlayerState(CommonEnvironment.this.simulation, whichPlayerState));
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetPlayerTechResearched", (arguments, globalScope, triggerScope) -> {
				final CPlayer player = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetPlayerTechCount", (arguments, globalScope, triggerScope) -> {
				final CPlayer player = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final int techIdRawcode = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
				final boolean specificOnly = arguments.get(2).visit(BooleanJassValueVisitor.getInstance());
				return new IntegerJassValue(player.getTechtreeUnlocked(new War3ID(techIdRawcode)));
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetPlayerTechResearched", (arguments, globalScope, triggerScope) -> {
				final CPlayer player = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final int techIdRawcode = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
				...
				final CUpgradeType upgradeType = CommonEnvironment.this.simulation.getUpgradeData().getType(techIdRawcodeId);
				if (upgradeType != null) {
					player.setTechResearched(CommonEnvironment.this.simulation, techIdRawcodeId, setToLevel);
				}
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("AddPlayerTechResearched", (arguments, globalScope, triggerScope) -> {
				final CPlayer player = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final int techIdRawcode = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("SetPlayerTechMaxAllowed", (arguments, globalScope, triggerScope) -> {
				final CPlayer player = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final int techIdRawcode = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetPlayerTechMaxAllowed", (arguments, globalScope, triggerScope) -> {
				final CPlayer player = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final int techIdRawcode = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
				return new IntegerJassValue(player.getTechtreeMaxAllowed(new War3ID(techIdRawcode)));
			});
			jassProgramVisitor.getJassNativeManager().createNative("IsFogEnabled", (arguments, globalScope, triggerScope) -> {
				// TODO fog of war!!
				return BooleanJassValue.FALSE;
			});
			jassProgramVisitor.getJassNativeManager().createNative("IsFogMaskEnabled", (arguments, globalScope, triggerScope) -> {
				// TODO fog of war!!
				return BooleanJassValue.FALSE;
			});
			jassProgramVisitor.getJassNativeManager().createNative("CreateSoundFromLabel", (arguments, globalScope, triggerScope) -> {
				final String soundLabel = arguments.get(0).visit(StringJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("CreateSound", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("SetSoundParamsFromLabel", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("VersionGet", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(versionType, CVersion.VALUES[WarsmashConstants.GAME_VERSION]);
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetAllItemTypeSlots", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("SetAllUnitTypeSlots", (arguments, globalScope, triggerScope) -> {
				final int slots = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
				CommonEnvironment.this.simulation.setAllItemTypeSlots(slots);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("TriggerRegisterPlayerUnitEvent", (arguments, globalScope, triggerScope) -> {
				final Trigger whichTrigger = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final CPlayer whichPlayer = arguments.get(1).visit(ObjectJassValueVisitor.getInstance());
				final JassGameEventsWar3 whichPlayerEvent = arguments.get(2).visit(ObjectJassValueVisitor.getInstance());
				final TriggerBooleanExpression filter = nullable(arguments, 3, ObjectJassValueVisitor.<TriggerBooleanExpression>getInstance());
				return new HandleJassValue(eventType, whichPlayer.addUnitEvent(globalScope, whichTrigger, whichPlayerEvent, filter));
			});
			jassProgramVisitor.getJassNativeManager().createNative("TriggerEvaluate", (arguments, globalScope, triggerScope) -> {
				final Trigger whichTrigger = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				if (whichTrigger == null) {
					return BooleanJassValue.FALSE;
				}
				return BooleanJassValue.of(whichTrigger.evaluate(globalScope, new CommonTriggerExecutionScope(whichTrigger, triggerScope)));
			});
			jassProgramVisitor.getJassNativeManager().createNative("TriggerExecute", (arguments, globalScope, triggerScope) -> {
				final Trigger whichTrigger = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				whichTrigger.execute(globalScope, new CommonTriggerExecutionScope(whichTrigger, triggerScope));
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("Preloader", (arguments, globalScope, triggerScope) -> {
				final String filename = arguments.get(0).visit(StringJassValueVisitor.getInstance());
				doPreloadScript(dataSource, war3MapViewer, filename);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("CreateTimerDialog", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("IsPlayerObserver", (arguments, globalScope, triggerScope) -> {
				final CPlayer player = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("SetSoundDuration", (arguments, globalScope, triggerScope) -> {
				final CSoundFilename sound = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final int duration = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
				// TODO NYI
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetSoundPitch", (arguments, globalScope, triggerScope) -> {
				final CSoundFilename sound = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final float pitch = arguments.get(1).visit(RealJassValueVisitor.getInstance()).floatValue();
				// TODO NYI
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetSoundVolume", (arguments, globalScope, triggerScope) -> {
				final CSoundFilename sound = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final int volume = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
				// TODO NYI
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("AddWeatherEffect", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("EnableWeatherEffect", (arguments, globalScope, triggerScope) -> {
				final Rectangle where = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final boolean enable = arguments.get(1).visit(BooleanJassValueVisitor.getInstance());
				// TODO NYI
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("TriggerRegisterDeathEvent", (arguments, globalScope, triggerScope) -> {
				final Trigger whichTrigger = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("TriggerRegisterUnitEvent", (arguments, globalScope, triggerScope) -> {
				final Trigger whichTrigger = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final CUnit whichWidget = arguments.get(1).visit(ObjectJassValueVisitor.getInstance());
				final JassGameEventsWar3 whichPlayerEvent = arguments.get(2).visit(ObjectJassValueVisitor.getInstance());
				return new HandleJassValue(eventType, whichWidget.addEvent(globalScope, whichTrigger, whichPlayerEvent));
			});
			jassProgramVisitor.getJassNativeManager().createNative("IsUnitHidden", (arguments, globalScope, triggerScope) -> {
				final CUnit unit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				if (unit == null) {
			...
			jassProgramVisitor.getJassNativeManager().createNative("PauseUnit", (arguments, globalScope, triggerScope) -> {
				final CUnit unit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final boolean flag = arguments.get(1).visit(BooleanJassValueVisitor.getInstance());
				unit.setPaused(flag);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetPlayerHandicapXP", (arguments, globalScope, triggerScope) -> {
				final CPlayer player = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final float handicap = arguments.get(1).visit(RealJassValueVisitor.getInstance()).floatValue();
				player.setHandicapXP(handicap);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetChangingUnit", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetChangingUnitPrevOwner", (arguments, globalScope, triggerScope) -> {
				// TODO this is supposed to have some magic nonsense going on where apparently
				// EVENT_WIDGET_DEATH
				// assigns to the return value of this and fires itself upon changing owner!!??
				return playerType.getNullValue();
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetRandomReal", (arguments, globalScope, triggerScope) -> {
				...
				return new RealJassValue((CommonEnvironment.this.simulation.getSeededRandom().nextFloat() * (highBound - lowBound)) + lowBound);
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetRandomInt", (arguments, globalScope, triggerScope) -> {
				...
				return new IntegerJassValue(CommonEnvironment.this.simulation.getSeededRandom().nextInt((highBound - lowBound) + 1) + lowBound);
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetWidgetX", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetWidgetY", (arguments, globalScope, triggerScope) -> {
				final CWidget whichWidget = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				return new RealJassValue(whichWidget.getY());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetUnitX", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetUnitY", (arguments, globalScope, triggerScope) -> {
				final CUnit whichWidget = nullable(arguments, 0, ObjectJassValueVisitor.getInstance());
				return new RealJassValue(whichWidget == null ? 0 : whichWidget.getY());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetUnitPointValue", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetUnitPointValueByType", (arguments, globalScope, triggerScope) -> {
				final int rawcode = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
				return new IntegerJassValue(CommonEnvironment.this.simulation.getUnitData().getUnitType(new War3ID(rawcode)).getPointValue());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetItemX", (arguments, globalScope, triggerScope) -> {
				final CItem whichWidget = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				return new RealJassValue(whichWidget.getX());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetItemY", (arguments, globalScope, triggerScope) -> {
				final CItem whichWidget = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				return new RealJassValue(whichWidget.getY());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetItemLoc", (arguments, globalScope, triggerScope) -> {
				final CItem whichWidget = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				return new HandleJassValue(locationType, new Point2D.Double(whichWidget.getX(), whichWidget.getY()));
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetUnitLoc", (arguments, globalScope, triggerScope) -> {
				final CUnit whichWidget = nullable(arguments, 0, ObjectJassValueVisitor.getInstance());
				if (whichWidget == null) {
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetUnitAbilityLevel", (arguments, globalScope, triggerScope) -> {
				final CUnit whichWidget = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final int rawcode = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
				if (whichWidget == null) {
					return IntegerJassValue.ZERO;
				}
				final CAbility ability = whichWidget.getAbility(GetAbilityByRawcodeVisitor.getInstance().reset(new War3ID(rawcode)));
				// TODO below code is very stupid!!
				return new IntegerJassValue(ability == null ? 0 : 1);
			});
			jassProgramVisitor.getJassNativeManager().createNative("IncUnitAbilityLevel", (arguments, globalScope, triggerScope) -> {
				final CUnit whichWidget = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final int rawcode = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
				final War3ID war3id = new War3ID(rawcode);
				final CAbility ability = whichWidget.getAbility(GetAbilityByRawcodeVisitor.getInstance().reset(war3id));
				if (ability == null) {
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetPlayerHandicap", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetHandleId", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("TriggerSleepAction", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("AddSpecialEffectTarget", (arguments, globalScope, triggerScope) -> {
				...
				return new HandleJassValue(effectType, war3MapViewer.addSpecialEffectTarget(modelName, targetWidget, attachPointName));
			});
			jassProgramVisitor.getJassNativeManager().createNative("AddSpecialEffectLoc", (arguments, globalScope, triggerScope) -> {
				final String modelName = arguments.get(0).visit(StringJassValueVisitor.getInstance());
				final Point2D.Double positionLoc = arguments.get(1).visit(ObjectJassValueVisitor.getInstance());
				return new HandleJassValue(effectType, war3MapViewer.addSpecialEffect(modelName, (float) positionLoc.x, (float) positionLoc.y, 0 /* facing */));
			});
			jassProgramVisitor.getJassNativeManager().createNative("AddSpellEffectById", (arguments, globalScope, triggerScope) -> {
				final int rawcode = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("BlzSetUnitFacingEx", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final double facing = arguments.get(1).visit(RealJassValueVisitor.getInstance());
				whichUnit.setFacing((float) facing);
			...
			jassProgramVisitor.getJassNativeManager().createNative("DestroyEffect", (arguments, globalScope, triggerScope) -> {
				final RenderSpellEffect fx = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				fx.setKillWhenDone(true);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetItemInvulnerable", (arguments, globalScope, triggerScope) -> {
				final CItem whichWidget = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final boolean flag = arguments.get(1).visit(BooleanJassValueVisitor.getInstance());
				whichWidget.setInvulernable(flag);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetDestructableInvulnerable", (arguments, globalScope, triggerScope) -> {
				final CDestructable whichWidget = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final boolean flag = arguments.get(1).visit(BooleanJassValueVisitor.getInstance());
				whichWidget.setInvulnerable(flag);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SuspendTimeOfDay", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("UnitAddItem", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("UnitAddAbility", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				...
				if (abilityTypeTmp == null) {
					System.err.println("UnitAddAbility: The requested ability has not been programmed yet: " + rawcode);
					return BooleanJassValue.FALSE;
				}
				final CLevelingAbility existingAbility = whichUnit.getAbility(GetAbilityByRawcodeVisitor.getInstance().reset(rawcode));
				if (existingAbility != null) {
					return BooleanJassValue.FALSE;
				}
				final CAbility ability = abilityTypeTmp.createAbility(CommonEnvironment.this.simulation.getHandleIdAllocator().createId());
				whichUnit.add(CommonEnvironment.this.simulation, ability);
				return BooleanJassValue.TRUE;
			});
			jassProgramVisitor.getJassNativeManager().createNative("UnitItemInSlot", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("SetCameraTargetController", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = nullable(arguments, 0, ObjectJassValueVisitor.getInstance());
				...
				meleeUI.getCameraManager().setTargetController(war3MapViewer.getRenderPeer(whichUnit), xoffset, yoffset, inheritOrientation);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("PanCameraToTimed", (arguments, globalScope, triggerScope) -> {
				final float x = arguments.get(0).visit(RealJassValueVisitor.getInstance()).floatValue();
				final float y = arguments.get(1).visit(RealJassValueVisitor.getInstance()).floatValue();
			...
			jassProgramVisitor.getJassNativeManager().createNative("LeaderboardGetPlayerIndex", (arguments, globalScope, triggerScope) -> {
				// TODO NYI
				return new IntegerJassValue(0);
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetUnitInvulnerable", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final boolean flag = arguments.get(1).visit(BooleanJassValueVisitor.getInstance());
				whichUnit.setInvulnerable(flag);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetUnitPositionLoc", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = nullable(arguments, 0, ObjectJassValueVisitor.getInstance());
				final Point2D.Double positionLoc = arguments.get(1).visit(ObjectJassValueVisitor.getInstance());
				if (whichUnit != null) {
					whichUnit.setPointAndCheckUnstuck((float) positionLoc.x, (float) positionLoc.y, CommonEnvironment.this.simulation);
				}
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetUnitPosition", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = nullable(arguments, 0, ObjectJassValueVisitor.getInstance());
				...
				if (whichUnit != null) {
					whichUnit.setPointAndCheckUnstuck((float) positionX, (float) positionY, CommonEnvironment.this.simulation);
				}
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("ShowUnit", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final boolean show = arguments.get(1).visit(BooleanJassValueVisitor.getInstance());
				whichUnit.setHidden(!show);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("KillUnit", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				whichUnit.kill(CommonEnvironment.this.simulation);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("RemoveUnit", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				CommonEnvironment.this.simulation.removeUnit(whichUnit);
				meleeUI.removedUnit(whichUnit);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("RemoveItem", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("SetUnitAnimation", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final String animation = CommonEnvironment.this.gameUI.getTrigStr(arguments.get(1).visit(StringJassValueVisitor.getInstance()));
				...
				if (!primaryTags.isEmpty()) {
					whichUnit.getUnitAnimationListener().playAnimation(true, primaryTags.iterator().next(), secondaryTags, 1.0f, true);
				}
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetTriggerWidget", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(widgetType, ((CommonTriggerExecutionScope) triggerScope).getTriggerWidget());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetPlayerRace", (arguments, globalScope, triggerScope) -> {
				final CPlayer whichPlayer = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				if (whichPlayer == null) {
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetUnitUserData", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				if (whichUnit == null) {
					return IntegerJassValue.ZERO;
				}
			...
			jassProgramVisitor.getJassNativeManager().createNative("SetUnitUserData", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetDestructableLife", (arguments, globalScope, triggerScope) -> {
				final CDestructable whichDestructable = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetDestructableMaxLife", (arguments, globalScope, triggerScope) -> {
				final CDestructable whichDestructable = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				return new RealJassValue(whichDestructable.getMaxLife());
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetDestructableAnimation", (arguments, globalScope, triggerScope) -> {
				final CDestructable whichDestructable = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
					final String animation = CommonEnvironment.this.gameUI.getTrigStr(arguments.get(1).visit(StringJassValueVisitor.getInstance()));
			...
			jassProgramVisitor.getJassNativeManager().createNative("DestructableRestoreLife", (arguments, globalScope, triggerScope) -> {
				final CDestructable whichDestructable = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("DisplayTimedTextToPlayer", (arguments, globalScope, triggerScope) -> {
				final CPlayer whichPlayer = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final float x = arguments.get(1).visit(RealJassValueVisitor.getInstance()).floatValue();
				final float y = arguments.get(2).visit(RealJassValueVisitor.getInstance()).floatValue();
				final float duration = arguments.get(3).visit(RealJassValueVisitor.getInstance()).floatValue();
				final String message = CommonEnvironment.this.gameUI.getTrigStr(arguments.get(4).visit(StringJassValueVisitor.getInstance()));
				System.err.println("DisplayTimedTextToPlayer: " + message.replace("\\n", "\n"));
				if (whichPlayer == CommonEnvironment.this.simulation.getPlayer(war3MapViewer.getLocalPlayerIndex())) {
					meleeUI.displayTimedText(x, y, duration, message);
				}
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("DisplayTextToPlayer", (arguments, globalScope, triggerScope) -> {
				final CPlayer whichPlayer = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final float x = arguments.get(1).visit(RealJassValueVisitor.getInstance()).floatValue();
				final float y = arguments.get(2).visit(RealJassValueVisitor.getInstance()).floatValue();
				final String message = CommonEnvironment.this.gameUI.getTrigStr(arguments.get(3).visit(StringJassValueVisitor.getInstance()));
				if (whichPlayer == CommonEnvironment.this.simulation.getPlayer(war3MapViewer.getLocalPlayerIndex())) {
					meleeUI.displayTimedText(x, y, (message.length() / 6) + 5, message);
				}
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("IsPlayerInForce", (arguments, globalScope, triggerScope) -> {
				final CPlayer whichPlayer = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final List<CPlayerJass> force = arguments.get(1).visit(ObjectJassValueVisitor.<List<CPlayerJass>>getInstance());
				return BooleanJassValue.of(force.contains(whichPlayer));
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetUnitTypeId", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = nullable(arguments, 0, ObjectJassValueVisitor.getInstance());
				if (whichUnit == null) {
					return new IntegerJassValue(0);
				}
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetItemTypeId", (arguments, globalScope, triggerScope) -> {
				final CItem whichItem = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				if (whichItem == null) {
					return new IntegerJassValue(0);
				}
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetItemType", (arguments, globalScope, triggerScope) -> {
				final CItem whichItem = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				if (whichItem == null) {
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetItemLevel", (arguments, globalScope, triggerScope) -> {
				final CItem whichItem = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				if (whichItem == null) {
					return new IntegerJassValue(0);
				}
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetOwningPlayer", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				if (whichUnit == null) {
					return playerType.getNullValue();
				}
				return new HandleJassValue(playerType, CommonEnvironment.this.simulation.getPlayer(whichUnit.getPlayerIndex()));
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetFilterPlayer", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(playerType, ((CommonTriggerExecutionScope) triggerScope).getFilterPlayer());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetDyingUnit", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(unitType, ((CommonTriggerExecutionScope) triggerScope).getDyingUnit());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetAttacker", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(unitType, ((CommonTriggerExecutionScope) triggerScope).getAttacker());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetKillingUnit", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(unitType, ((CommonTriggerExecutionScope) triggerScope).getKillingUnit());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetTriggerUnit", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(unitType, ((CommonTriggerExecutionScope) triggerScope).getTriggeringUnit());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetTriggerDestructable", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetOrderedUnit", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(unitType, ((CommonTriggerExecutionScope) triggerScope).getOrderedUnit());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetManipulatedItem", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(itemType, ((CommonTriggerExecutionScope) triggerScope).getManipulatedItem());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetManipulatingUnit", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(unitType, ((CommonTriggerExecutionScope) triggerScope).getManipulatingUnit());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetIssuedOrderId", (arguments, globalScope, triggerScope) -> {
				return new IntegerJassValue(((CommonTriggerExecutionScope) triggerScope).getIssuedOrderId());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetOrderPointX", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetOrderTarget", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(widgetType, ((CommonTriggerExecutionScope) triggerScope).getOrderTarget());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetOrderTargetDestructable", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(destructableType, ((CommonTriggerExecutionScope) triggerScope).getOrderTargetDestructable());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetOrderTargetItem", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(itemType, ((CommonTriggerExecutionScope) triggerScope).getOrderTargetItem());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetOrderTargetUnit", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(unitType, ((CommonTriggerExecutionScope) triggerScope).getOrderTargetUnit());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetSpellAbilityUnit", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(unitType, ((CommonTriggerExecutionScope) triggerScope).getSpellAbilityUnit());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetSpellTargetUnit", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(unitType, ((CommonTriggerExecutionScope) triggerScope).getSpellTargetUnit());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetSpellTargetPoint", (arguments, globalScope, triggerScope) -> {
				final AbilityPointTarget spellTargetPoint = ((CommonTriggerExecutionScope) triggerScope).getSpellTargetPoint();
				final Point2D.Double jassLocation = new Point2D.Double(spellTargetPoint.x, spellTargetPoint.y);
				return new HandleJassValue(locationType, jassLocation);
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetSpellTargetX", (arguments, globalScope, triggerScope) -> {
				final AbilityPointTarget spellTargetPoint = ((CommonTriggerExecutionScope) triggerScope).getSpellTargetPoint();
				return new RealJassValue(spellTargetPoint.x);
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetSpellTargetY", (arguments, globalScope, triggerScope) -> {
				final AbilityPointTarget spellTargetPoint = ((CommonTriggerExecutionScope) triggerScope).getSpellTargetPoint();
				return new RealJassValue(spellTargetPoint.y);
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetSpellTargetLoc", (arguments, globalScope, triggerScope) -> {
				final AbilityPointTarget spellTargetPoint = ((CommonTriggerExecutionScope) triggerScope).getSpellTargetPoint();
				return new HandleJassValue(locationType, new Point2D.Double(spellTargetPoint.x, spellTargetPoint.y));
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetSpellAbilityId", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetEnumPlayer", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(playerType, ((CommonTriggerExecutionScope) triggerScope).getEnumPlayer());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetConstructedStructure", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(unitType, ((CommonTriggerExecutionScope) triggerScope).getConstructedStructure());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetResearchingUnit", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(unitType, ((CommonTriggerExecutionScope) triggerScope).getResearchingUnit());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetResearched", (arguments, globalScope, triggerScope) -> {
				return new IntegerJassValue(((CommonTriggerExecutionScope) triggerScope).getResearched());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetTrainedUnit", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(unitType, ((CommonTriggerExecutionScope) triggerScope).getTrainedUnit());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetTrainedUnitType", (arguments, globalScope, triggerScope) -> {
				return new IntegerJassValue(((CommonTriggerExecutionScope) triggerScope).getTrainedUnitType());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetUnitRallyPoint", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = nullable(arguments, 0, ObjectJassValueVisitor.getInstance());
				float x, y;
				if (whichUnit != null) {
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetUnitRallyUnit", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = nullable(arguments, 0, ObjectJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetUnitRallyDestructable", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = nullable(arguments, 0, ObjectJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetUnitCurrentOrder", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = nullable(arguments, 0, ObjectJassValueVisitor.getInstance());
				int orderId;
			...
			jassProgramVisitor.getJassNativeManager().createNative("SetBlightLoc", (arguments, globalScope, triggerScope) -> {
				final CPlayer whichPlayer = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetLocalPlayer", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(playerType, CommonEnvironment.this.simulation.getPlayer(war3MapViewer.getLocalPlayerIndex()));
			});
			jassProgramVisitor.getJassNativeManager().createNative("IsUnitInGroup", (arguments, globalScope, triggerScope) -> {
			...
			// 	}
			// });
			jassProgramVisitor.getJassNativeManager().createNative("InitHashtable", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(hashtableType, new CHashtable());
			});
			...
			jassProgramVisitor.getJassNativeManager().createNative("SaveDestructableHandle", new SaveHashtableValueFunc());
			...
			jassProgramVisitor.getJassNativeManager().createNative("SaveTriggerConditionHandle", new SaveHashtableValueFunc());
			jassProgramVisitor.getJassNativeManager().createNative("SaveTriggerActionHandle", new SaveHashtableValueFunc());
			jassProgramVisitor.getJassNativeManager().createNative("SaveTriggerEventHandle", new SaveHashtableValueFunc());
			...
			jassProgramVisitor.getJassNativeManager().createNative("SaveBooleanExprHandle", new SaveHashtableValueFunc());
			...
			jassProgramVisitor.getJassNativeManager().createNative("SaveDefeatConditionHandle", new SaveHashtableValueFunc());
			jassProgramVisitor.getJassNativeManager().createNative("SaveTimerDialogHandle", new SaveHashtableValueFunc());
			jassProgramVisitor.getJassNativeManager().createNative("SaveLeaderboardHandle", new SaveHashtableValueFunc());
			jassProgramVisitor.getJassNativeManager().createNative("SaveMultiboardHandle", new SaveHashtableValueFunc());
			jassProgramVisitor.getJassNativeManager().createNative("SaveMultiboardItemHandle", new SaveHashtableValueFunc());
			...
			jassProgramVisitor.getJassNativeManager().createNative("SaveFogModifierHandle", new SaveHashtableValueFunc());
			...
			jassProgramVisitor.getJassNativeManager().createNative("LoadInteger", new LoadHashtableValueFunc(IntegerJassValue.ZERO));
			jassProgramVisitor.getJassNativeManager().createNative("LoadReal", new LoadHashtableValueFunc(RealJassValue.ZERO));
			jassProgramVisitor.getJassNativeManager().createNative("LoadBoolean", new LoadHashtableValueFunc(BooleanJassValue.FALSE));
			jassProgramVisitor.getJassNativeManager().createNative("LoadStr", new LoadHashtableValueFunc(StringJassValue.EMPTY_STRING));
			...
			jassProgramVisitor.getJassNativeManager().createNative("LoadSoundHandle", new LoadHashtableValueFunc(new HandleJassValue(soundType, null)));

			jassProgramVisitor.getJassNativeManager().createNative("HaveSavedInteger", new HaveSavedHashtableValueFunc(JassType.INTEGER));
			jassProgramVisitor.getJassNativeManager().createNative("HaveSavedReal", new HaveSavedHashtableValueFunc(JassType.REAL));
			jassProgramVisitor.getJassNativeManager().createNative("HaveSavedBoolean", new HaveSavedHashtableValueFunc(JassType.BOOLEAN));
			jassProgramVisitor.getJassNativeManager().createNative("HaveSavedString", new HaveSavedHashtableValueFunc(JassType.STRING));
			jassProgramVisitor.getJassNativeManager().createNative("HaveSavedHandle", new HaveSavedHashtableValueFunc(agentType));

			jassProgramVisitor.getJassNativeManager().createNative("GetExpiredTimer", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(timerType, ((CommonTriggerExecutionScope) triggerScope).getExpiringTimer());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetPlayerStructureCount", (arguments, globalScope, triggerScope) -> {
				final CPlayer whichPlayer = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetPlayerTypedUnitCount", (arguments, globalScope, triggerScope) -> {
				final CPlayer whichPlayer = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final String legacySystemUnitTypeName = arguments.get(1).visit(StringJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("IsUnitEnemy", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final CPlayer whichPlayer = arguments.get(1).visit(ObjectJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("IsUnitAlly", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final CPlayer whichPlayer = arguments.get(1).visit(ObjectJassValueVisitor.getInstance());
				if ((whichUnit == null) || (whichPlayer == null)) {
					return BooleanJassValue.FALSE;
			...
			jassProgramVisitor.getJassNativeManager().createNative("IsNoVictoryCheat", (arguments, globalScope, triggerScope) -> {
				return BooleanJassValue.FALSE;
			});
			jassProgramVisitor.getJassNativeManager().createNative("IsNoDefeatCheat", (arguments, globalScope, triggerScope) -> {
				return BooleanJassValue.FALSE;
			});

			// Warsmash Ability API
			jassProgramVisitor.getJassNativeManager().createNative("GetUnitMoveFollowBehavior", (arguments, globalScope, triggerScope) -> {
				...
				return new HandleJassValue(abilitybehaviorType, unit.getFollowBehavior().reset(highlightOrderId, whichFollowTarget));
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetUnitMovePointBehavior", (arguments, globalScope, triggerScope) -> {
				final CUnit unit = nullable(arguments, 0, ObjectJassValueVisitor.getInstance());
				final int highlightOrderId = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
				...
				return new HandleJassValue(abilitybehaviorType, unit.getMoveBehavior().reset(highlightOrderId, new AbilityPointTarget((float) targetX, (float) targetY)));
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetUnitMovePointBehaviorLoc", (arguments, globalScope, triggerScope) -> {
				final CUnit unit = nullable(arguments, 0, ObjectJassValueVisitor.getInstance());
				final int highlightOrderId = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
				...
				return new HandleJassValue(abilitybehaviorType, unit.getMoveBehavior().reset(highlightOrderId, new AbilityPointTarget((float) target.x, (float) target.y)));
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetUnitAttackMovePointBehavior", (arguments, globalScope, triggerScope) -> {
				final CUnit unit = nullable(arguments, 0, ObjectJassValueVisitor.getInstance());
				...
				return new HandleJassValue(abilitybehaviorType, unit.getAttackMoveBehavior().reset(new AbilityPointTarget((float) targetX, (float) targetY)));
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetUnitAttackMovePointBehaviorLoc", (arguments, globalScope, triggerScope) -> {
				final CUnit unit = nullable(arguments, 0, ObjectJassValueVisitor.getInstance());
				final Point2D.Double target = arguments.get(1).visit(ObjectJassValueVisitor.getInstance());
				if (unit == null) {
					return null;
				}
				return new HandleJassValue(abilitybehaviorType, unit.getAttackMoveBehavior().reset(new AbilityPointTarget((float) target.x, (float) target.y)));
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetUnitAttackWidgetBehavior", (arguments, globalScope, triggerScope) -> {
				final CUnit unit = nullable(arguments, 0, ObjectJassValueVisitor.getInstance());
				final int highlightOrderId = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetUnitAttackGroundBehavior", (arguments, globalScope, triggerScope) -> {
				final CUnit unit = nullable(arguments, 0, ObjectJassValueVisitor.getInstance());
				final int highlightOrderId = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
				final int whichUnitAttackIndex = arguments.get(2).visit(IntegerJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetUnitAttackGroundBehaviorLoc", (arguments, globalScope, triggerScope) -> {
				final CUnit unit = nullable(arguments, 0, ObjectJassValueVisitor.getInstance());
				final int highlightOrderId = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
				final int whichUnitAttackIndex = arguments.get(2).visit(IntegerJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("UnitPollNextOrderBehavior", (arguments, globalScope, triggerScope) -> {
				final CUnit whichUnit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				return new HandleJassValue(abilitybehaviorType, whichUnit.pollNextOrderBehavior(CommonEnvironment.this.simulation));
			});
			jassProgramVisitor.getJassNativeManager().createNative("CreateAbilityBehavior", (arguments, globalScope, triggerScope) -> {
				...
				return new HandleJassValue(abilitybehaviorType, new CBehaviorJass(highlightOrderId, func, globalScope));
			});
			jassProgramVisitor.getJassNativeManager().createNative("CreateBehaviorExpr", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("GetSpellAbilityOrderId", (arguments, globalScope, triggerScope) -> {
				return new IntegerJassValue(((CommonTriggerExecutionScope) triggerScope).getSpellAbilityOrderId());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetSpellAbilityOrderButton", (arguments, globalScope, triggerScope) -> {
				return new IntegerJassValue(((CommonTriggerExecutionScope) triggerScope).getSpellAbilityOrderId());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetSpellTargetType", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(orderbuttontypeType, ((CommonTriggerExecutionScope) triggerScope).getSpellAbilityTargetType());
			});
			jassProgramVisitor.getJassNativeManager().createNative("CreateAbilityType", (arguments, globalScope, triggerScope) -> {
				return new HandleJassValue(abilitytypeType, new CAbilityTypeJassDefinition(globalScope));
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetAbilityTypeOnAddAction", (arguments, globalScope, triggerScope) -> {
				final CAbilityTypeJassDefinition whichAbilityType = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final JassFunction func = arguments.get(1).visit(JassFunctionJassValueVisitor.getInstance());
				whichAbilityType.setOnAddJass(func);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetAbilityTypeOnRemoveAction", (arguments, globalScope, triggerScope) -> {
				final CAbilityTypeJassDefinition whichAbilityType = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final JassFunction func = arguments.get(1).visit(JassFunctionJassValueVisitor.getInstance());
				whichAbilityType.setOnRemoveJass(func);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetAbilityTypeOnTickAction", (arguments, globalScope, triggerScope) -> {
				final CAbilityTypeJassDefinition whichAbilityType = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final JassFunction func = arguments.get(1).visit(JassFunctionJassValueVisitor.getInstance());
				whichAbilityType.setOnTickJass(func);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetAbilityTypeOnDeathAction", (arguments, globalScope, triggerScope) -> {
				final CAbilityTypeJassDefinition whichAbilityType = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final JassFunction func = arguments.get(1).visit(JassFunctionJassValueVisitor.getInstance());
				whichAbilityType.setOnDeathJass(func);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetAbilityTypeOnCancelFromQueueAction", (arguments, globalScope, triggerScope) -> {
				final CAbilityTypeJassDefinition whichAbilityType = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final JassFunction func = arguments.get(1).visit(JassFunctionJassValueVisitor.getInstance());
				whichAbilityType.setOnCancelFromQueueJass(func);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetAbilityTypeOnCheckBeforeQueueQueueCondition", (arguments, globalScope, triggerScope) -> {
				final CAbilityTypeJassDefinition whichAbilityType = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final TriggerBooleanExpression boolExpr = arguments.get(1).visit(ObjectJassValueVisitor.getInstance());
				whichAbilityType.setCheckBeforeQueueJass(boolExpr);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetAbilityTypeCheckTargetCondition", (arguments, globalScope, triggerScope) -> {
				final CAbilityTypeJassDefinition whichAbilityType = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final TriggerBooleanExpression boolExpr = arguments.get(1).visit(ObjectJassValueVisitor.getInstance());
				whichAbilityType.setCheckTargetCondition(boolExpr);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetAbilityTypeCheckUseCondition", (arguments, globalScope, triggerScope) -> {
				final CAbilityTypeJassDefinition whichAbilityType = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final TriggerBooleanExpression boolExpr = arguments.get(1).visit(ObjectJassValueVisitor.getInstance());
				whichAbilityType.setCheckUseCondition(boolExpr);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetAbilityTypeEnabledWhileUnderConstruction", (arguments, globalScope, triggerScope) -> {
				final CAbilityTypeJassDefinition whichAbilityType = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("SetAbilityTypeEnabledWhileUpgrading", (arguments, globalScope, triggerScope) -> {
				final CAbilityTypeJassDefinition whichAbilityType = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final boolean enabled = arguments.get(1).visit(BooleanJassValueVisitor.getInstance());
				whichAbilityType.setEnabledWhileUpgrading(enabled);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetAbilityTypeBehavior", (arguments, globalScope, triggerScope) -> {
				final CAbilityTypeJassDefinition whichAbilityType = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final BehaviorExpr expr = arguments.get(1).visit(ObjectJassValueVisitor.getInstance());
				whichAbilityType.setBeginJass(expr);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("RegisterAbilityType", (arguments, globalScope, triggerScope) -> {
				final int rawcode = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
				final CAbilityTypeJassDefinition whichAbilityType = nullable(arguments, 1, ObjectJassValueVisitor.getInstance());
				CommonEnvironment.this.simulation.getAbilityData().registerJassType(new War3ID(rawcode), whichAbilityType);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetUnitIconUI", (arguments, globalScope, triggerScope) -> {
				final int rawcode = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
				return new HandleJassValue(iconuiType, war3MapViewer.getAbilityDataUI().getUnitUI(new War3ID(rawcode)));
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetAbilityOnIconUI", (arguments, globalScope, triggerScope) -> {
				final int rawcode = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
				return new HandleJassValue(iconuiType, war3MapViewer.getAbilityDataUI().getUI(new War3ID(rawcode)).getOnIconUI(0));
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetAbilityOffIconUI", (arguments, globalScope, triggerScope) -> {
				final int rawcode = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
				return new HandleJassValue(iconuiType, war3MapViewer.getAbilityDataUI().getUI(new War3ID(rawcode)).getOffIconUI(0));
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetAbilityLearnIconUI", (arguments, globalScope, triggerScope) -> {
				final int rawcode = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
				return new HandleJassValue(iconuiType, war3MapViewer.getAbilityDataUI().getUI(new War3ID(rawcode)).getLearnIconUI());
			});
			jassProgramVisitor.getJassNativeManager().createNative("GetItemIconUI", (arguments, globalScope, triggerScope) -> {
				final int rawcode = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
				return new HandleJassValue(iconuiType, war3MapViewer.getAbilityDataUI().getItemUI(new War3ID(rawcode)));
			});
			jassProgramVisitor.getJassNativeManager().createNative("CreateOrderButton", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("AbilityTypeAddOrderButton", (arguments, globalScope, triggerScope) -> {
				final CAbilityTypeJassDefinition abilityTypeTmp = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("AbilityTypeRemoveOrderButton", (arguments, globalScope, triggerScope) -> {
				final CAbilityTypeJassDefinition abilityTypeTmp = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final JassOrder commandCard = arguments.get(1).visit(ObjectJassValueVisitor.getInstance());
				abilityTypeTmp.removeJassOrder(commandCard);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetOrderButtonAutoCastOrderId", (arguments, globalScope, triggerScope) -> {
			...
			jassProgramVisitor.getJassNativeManager().createNative("SetOrderButtonUnAutoCastOrderId", (arguments, globalScope, triggerScope) -> {
				final JassOrder orderCommandCard = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("SetOrderButtonContainerMenuOrderId", (arguments, globalScope, triggerScope) -> {
				final JassOrder orderCommandCard = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final int orderId = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
				orderCommandCard.setContainerMenuOrderId(orderId);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetOrderButtonDisabled", (arguments, globalScope, triggerScope) -> {
				final JassOrder orderCommandCard = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final boolean disabled = arguments.get(1).visit(BooleanJassValueVisitor.getInstance());
				orderCommandCard.setDisabled(disabled);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetOrderButtonManaCost", (arguments, globalScope, triggerScope) -> {
				final JassOrder orderCommandCard = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final int manaCost = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
				orderCommandCard.setManaCost(manaCost);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetOrderButtonGoldCost", (arguments, globalScope, triggerScope) -> {
				final JassOrder orderCommandCard = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final int goldCost = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
				orderCommandCard.setGoldCost(goldCost);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetOrderButtonLumberCost", (arguments, globalScope, triggerScope) -> {
				final JassOrder orderCommandCard = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final int lumberCost = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
				orderCommandCard.setLumberCost(lumberCost);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetOrderButtonFoodCostDisplayOnly", (arguments, globalScope, triggerScope) -> {
				final JassOrder orderCommandCard = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("SetOrderButtonCharges", (arguments, globalScope, triggerScope) -> {
				final JassOrder orderCommandCard = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final int charges = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
				orderCommandCard.setCharges(charges);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetOrderButtonAutoCastActive", (arguments, globalScope, triggerScope) -> {
				final JassOrder orderCommandCard = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final boolean active = arguments.get(1).visit(BooleanJassValueVisitor.getInstance());
				orderCommandCard.setAutoCastActive(active);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetOrderButtonHidden", (arguments, globalScope, triggerScope) -> {
				final JassOrder orderCommandCard = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final boolean hidden = arguments.get(1).visit(BooleanJassValueVisitor.getInstance());
				orderCommandCard.setHidden(hidden);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetOrderButtonIconPath", (arguments, globalScope, triggerScope) -> {
				final JassOrder orderCommandCard = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final String iconPath = arguments.get(1).visit(StringJassValueVisitor.getInstance());
				orderCommandCard.setIconPath(iconPath);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetOrderButtonButtonPositionX", (arguments, globalScope, triggerScope) -> {
				final JassOrder orderCommandCard = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("SetOrderButtonButtonPositionY", (arguments, globalScope, triggerScope) -> {
				final JassOrder orderCommandCard = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("SetOrderButtonToolTip", (arguments, globalScope, triggerScope) -> {
				final JassOrder orderCommandCard = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final String tip = arguments.get(1).visit(StringJassValueVisitor.getInstance());
				orderCommandCard.setTip(tip);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetOrderButtonUberTip", (arguments, globalScope, triggerScope) -> {
				final JassOrder orderCommandCard = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
				final String uberTip = arguments.get(1).visit(StringJassValueVisitor.getInstance());
				orderCommandCard.setUberTip(uberTip);
				return null;
			});
			jassProgramVisitor.getJassNativeManager().createNative("SetOrderButtonHotKey", (arguments, globalScope, triggerScope) -> {
				final JassOrder orderCommandCard = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("SetOrderButtonPreviewBuildUnitId", (arguments, globalScope, triggerScope) -> {
				final JassOrder orderCommandCard = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
			...
			jassProgramVisitor.getJassNativeManager().createNative("SetOrderButtonAOE", (arguments, globalScope, triggerScope) -> {
				final JassOrder orderCommandCard = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
	...
	private static void setupTriggerAPI(final JassProgramVisitor jassProgramVisitor, final HandleJassType triggerType,
		...
		// Native trigger interface
		//
		jassProgramVisitor.getJassNativeManager().createNative("CreateTrigger", (arguments, globalScope, triggerScope) -> {
			return new HandleJassValue(triggerType, new Trigger());
		});
		jassProgramVisitor.getJassNativeManager().createNative("DestroyTrigger", (arguments, globalScope, triggerScope) -> {
			final Trigger trigger = arguments.get(0).visit(ObjectJassValueVisitor.<Trigger>getInstance());
			trigger.destroy();
			return null;
		});
		jassProgramVisitor.getJassNativeManager().createNative("ResetTrigger", (arguments, globalScope, triggerScope) -> {
			final Trigger trigger = arguments.get(0).visit(ObjectJassValueVisitor.<Trigger>getInstance());
			trigger.reset();
			return null;
		});
		jassProgramVisitor.getJassNativeManager().createNative("EnableTrigger", (arguments, globalScope, triggerScope) -> {
			final Trigger trigger = arguments.get(0).visit(ObjectJassValueVisitor.<Trigger>getInstance());
			trigger.setEnabled(true);
			return null;
		});
		jassProgramVisitor.getJassNativeManager().createNative("DisableTrigger", (arguments, globalScope, triggerScope) -> {
			final Trigger trigger = arguments.get(0).visit(ObjectJassValueVisitor.<Trigger>getInstance());
			trigger.setEnabled(false);
			return null;
		});
		jassProgramVisitor.getJassNativeManager().createNative("IsTriggerEnabled", (arguments, globalScope, triggerScope) -> {
			final Trigger trigger = arguments.get(0).visit(ObjectJassValueVisitor.<Trigger>getInstance());
			return BooleanJassValue.of(trigger.isEnabled());
		});
		jassProgramVisitor.getJassNativeManager().createNative("TriggerWaitOnSleeps", (arguments, globalScope, triggerScope) -> {
			final Trigger trigger = arguments.get(0).visit(ObjectJassValueVisitor.<Trigger>getInstance());
			final Boolean value = arguments.get(1).visit(BooleanJassValueVisitor.getInstance());
			trigger.setWaitOnSleeps(value.booleanValue());
			return null;
		});
		jassProgramVisitor.getJassNativeManager().createNative("IsTriggerWaitOnSleeps", (arguments, globalScope, triggerScope) -> {
			final Trigger trigger = arguments.get(0).visit(ObjectJassValueVisitor.<Trigger>getInstance());
			return BooleanJassValue.of(trigger.isWaitOnSleeps());
		});
		jassProgramVisitor.getJassNativeManager().createNative("GetTriggeringTrigger", (arguments, globalScope, triggerScope) -> {
			return new HandleJassValue(triggerType, triggerScope.getTriggeringTrigger());
		});
		jassProgramVisitor.getJassNativeManager().createNative("GetTriggerEventId", (arguments, globalScope, triggerScope) -> {
			return new HandleJassValue(eventidType, ((CommonTriggerExecutionScope) triggerScope).getTriggerEventId());
		});
		jassProgramVisitor.getJassNativeManager().createNative("GetTriggerEvalCount", (arguments, globalScope, triggerScope) -> {
			final Trigger trigger = arguments.get(0).visit(ObjectJassValueVisitor.<Trigger>getInstance());
			return new IntegerJassValue(trigger.getEvalCount());
		});
		jassProgramVisitor.getJassNativeManager().createNative("GetTriggerExecCount", (arguments, globalScope, triggerScope) -> {
			final Trigger trigger = arguments.get(0).visit(ObjectJassValueVisitor.<Trigger>getInstance());
			return new IntegerJassValue(trigger.getExecCount());
		});
		jassProgramVisitor.getJassNativeManager().createNative("ExecuteFunc", (arguments, globalScope, triggerScope) -> {
		...
		jassProgramVisitor.getJassNativeManager().createNative("And", (arguments, globalScope, triggerScope) -> {
			final TriggerBooleanExpression operandA = arguments.get(0).visit(ObjectJassValueVisitor.<TriggerBooleanExpression>getInstance());
			final TriggerBooleanExpression operandB = arguments.get(1).visit(ObjectJassValueVisitor.<TriggerBooleanExpression>getInstance());
		...
		jassProgramVisitor.getJassNativeManager().createNative("Not", (arguments, globalScope, triggerScope) -> {
			final TriggerBooleanExpression operand = arguments.get(0).visit(ObjectJassValueVisitor.<TriggerBooleanExpression>getInstance());
		...
		jassProgramVisitor.getJassNativeManager().createNative("DestroyCondition", (arguments, globalScope, triggerScope) -> {
			final BoolExprCondition condition = arguments.get(0).visit(ObjectJassValueVisitor.<BoolExprCondition>getInstance());
		...
		jassProgramVisitor.getJassNativeManager().createNative("DestroyFilter", (arguments, globalScope, triggerScope) -> {
			final BoolExprFilter filter = arguments.get(0).visit(ObjectJassValueVisitor.<BoolExprFilter>getInstance());
		...
		jassProgramVisitor.getJassNativeManager().createNative("DestroyBoolExpr", (arguments, globalScope, triggerScope) -> {
			final TriggerBooleanExpression boolexpr = arguments.get(0).visit(ObjectJassValueVisitor.<TriggerBooleanExpression>getInstance());
		...
		jassProgramVisitor.getJassNativeManager().createNative("TriggerAddCondition", (arguments, globalScope, triggerScope) -> {
			final Trigger whichTrigger = arguments.get(0).visit(ObjectJassValueVisitor.<Trigger>getInstance());
			final TriggerBooleanExpression condition = arguments.get(1).visit(ObjectJassValueVisitor.<TriggerBooleanExpression>getInstance());
		...
		jassProgramVisitor.getJassNativeManager().createNative("TriggerRemoveCondition", (arguments, globalScope, triggerScope) -> {
			final Trigger whichTrigger = arguments.get(0).visit(ObjectJassValueVisitor.<Trigger>getInstance());
		...
		jassProgramVisitor.getJassNativeManager().createNative("TriggerClearConditions", (arguments, globalScope, triggerScope) -> {
			final Trigger whichTrigger = arguments.get(0).visit(ObjectJassValueVisitor.<Trigger>getInstance());
			whichTrigger.clearConditions();
			return null;
		});
		jassProgramVisitor.getJassNativeManager().createNative("TriggerAddAction", (arguments, globalScope, triggerScope) -> {
			final Trigger whichTrigger = arguments.get(0).visit(ObjectJassValueVisitor.<Trigger>getInstance());
...
//							parser.removeErrorListener(ConsoleErrorListener.INSTANCE);
	...
	private static void registerConfigNatives(final JassProgramVisitor jassProgramVisitor,
		...
		jassProgramVisitor.getJassNativeManager().createNative("SetMapDescription", (arguments, globalScope, triggerScope) -> {
			final String name = arguments.get(0).visit(StringJassValueVisitor.getInstance());
		...
		jassProgramVisitor.getJassNativeManager().createNative("DefineStartLocation", (arguments, globalScope, triggerScope) -> {
		...
		jassProgramVisitor.getJassNativeManager().createNative("DefineStartLocationLoc", (arguments, globalScope, triggerScope) -> {
			final Integer whichStartLoc = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			final Point2D.Double whichLocation = arguments.get(1).visit(ObjectJassValueVisitor.<Point2D.Double>getInstance());
		...
		jassProgramVisitor.getJassNativeManager().createNative("SetStartLocPrioCount", (arguments, globalScope, triggerScope) -> {
			final Integer whichStartLoc = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
		...
		jassProgramVisitor.getJassNativeManager().createNative("SetStartLocPrio", (arguments, globalScope, triggerScope) -> {
			final Integer whichStartLoc = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			...
			final CStartLocPrio priority = arguments.get(1).visit(ObjectJassValueVisitor.<CStartLocPrio>getInstance());
			mapConfig.getStartLoc(whichStartLoc).setStartLocPrio(prioSlotIndex, otherStartLocIndex, priority);
			return null;
		});
		jassProgramVisitor.getJassNativeManager().createNative("GetStartLocPrioSlot", (arguments, globalScope, triggerScope) -> {
			final Integer whichStartLoc = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			final Integer prioSlotIndex = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
			return new IntegerJassValue(mapConfig.getStartLoc(whichStartLoc).getOtherStartIndices()[prioSlotIndex]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("GetStartLocPrio", (arguments, globalScope, triggerScope) -> {
			final Integer whichStartLoc = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			final Integer prioSlotIndex = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(startlocprioType, mapConfig.getStartLoc(whichStartLoc).getOtherStartLocPriorities()[prioSlotIndex]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("SetGameTypeSupported", (arguments, globalScope, triggerScope) -> {
		...
		jassProgramVisitor.getJassNativeManager().createNative("SetGamePlacement", (arguments, globalScope, triggerScope) -> {
			final CMapPlacement placement = arguments.get(0).visit(ObjectJassValueVisitor.<CMapPlacement>getInstance());
			mapConfig.setPlacement(placement);
			return null;
		});
		jassProgramVisitor.getJassNativeManager().createNative("SetGameSpeed", (arguments, globalScope, triggerScope) -> {
		...
		jassProgramVisitor.getJassNativeManager().createNative("SetGameDifficulty", (arguments, globalScope, triggerScope) -> {
			final CMapDifficulty gameDifficulty = arguments.get(0).visit(ObjectJassValueVisitor.<CMapDifficulty>getInstance());
			mapConfig.setGameDifficulty(gameDifficulty);
			return null;
		});
		jassProgramVisitor.getJassNativeManager().createNative("SetResourceDensity", (arguments, globalScope, triggerScope) -> {
			final CMapDensity resourceDensity = arguments.get(0).visit(ObjectJassValueVisitor.<CMapDensity>getInstance());
			mapConfig.setResourceDensity(resourceDensity);
			return null;
		});
		jassProgramVisitor.getJassNativeManager().createNative("SetCreatureDensity", (arguments, globalScope, triggerScope) -> {
			final CMapDensity creatureDensity = arguments.get(0).visit(ObjectJassValueVisitor.<CMapDensity>getInstance());
		...
		jassProgramVisitor.getJassNativeManager().createNative("IsGameTypeSupported", (arguments, globalScope, triggerScope) -> {
			final CGameType gameType = arguments.get(0).visit(ObjectJassValueVisitor.<CGameType>getInstance());
			return BooleanJassValue.of(mapConfig.isGameTypeSupported(gameType));
		});
		jassProgramVisitor.getJassNativeManager().createNative("GetGameTypeSelected", (arguments, globalScope, triggerScope) -> {
			return new HandleJassValue(gametypeType, mapConfig.getGameTypeSelected());
		});
		jassProgramVisitor.getJassNativeManager().createNative("IsMapFlagSet", (arguments, globalScope, triggerScope) -> {
			final CMapFlag mapFlag = arguments.get(0).visit(ObjectJassValueVisitor.<CMapFlag>getInstance());
			return BooleanJassValue.of(mapConfig.isMapFlagSet(mapFlag));
		});
		jassProgramVisitor.getJassNativeManager().createNative("GetGamePlacement", (arguments, globalScope, triggerScope) -> {
			return new HandleJassValue(placementType, mapConfig.getPlacement());
		});
		jassProgramVisitor.getJassNativeManager().createNative("GetGameSpeed", (arguments, globalScope, triggerScope) -> {
			return new HandleJassValue(gamespeedType, mapConfig.getGameSpeed());
		});
		jassProgramVisitor.getJassNativeManager().createNative("GetGameDifficulty", (arguments, globalScope, triggerScope) -> {
			return new HandleJassValue(gamedifficultyType, mapConfig.getGameDifficulty());
		});
		jassProgramVisitor.getJassNativeManager().createNative("GetResourceDensity", (arguments, globalScope, triggerScope) -> {
			return new HandleJassValue(mapdensityType, mapConfig.getResourceDensity());
		});
		jassProgramVisitor.getJassNativeManager().createNative("GetCreatureDensity", (arguments, globalScope, triggerScope) -> {
			return new HandleJassValue(mapdensityType, mapConfig.getCreatureDensity());
		});
		jassProgramVisitor.getJassNativeManager().createNative("GetStartLocationX", (arguments, globalScope, triggerScope) -> {
			final Integer whichStartLoc = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new RealJassValue(mapConfig.getStartLoc(whichStartLoc).getX());
		});
		jassProgramVisitor.getJassNativeManager().createNative("GetStartLocationY", (arguments, globalScope, triggerScope) -> {
			final Integer whichStartLoc = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new RealJassValue(mapConfig.getStartLoc(whichStartLoc).getY());
		});
		jassProgramVisitor.getJassNativeManager().createNative("GetStartLocationLoc", (arguments, globalScope, triggerScope) -> {
			final Integer whichStartLoc = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(locationType, new Point2D.Double(mapConfig.getStartLoc(whichStartLoc).getX(), mapConfig.getStartLoc(whichStartLoc).getY()));
		});
		// PlayerAPI

		jassProgramVisitor.getJassNativeManager().createNative("SetPlayerTeam", (arguments, globalScope, triggerScope) -> {
		...
		jassProgramVisitor.getJassNativeManager().createNative("SetPlayerStartLocation", (arguments, globalScope, triggerScope) -> {
			final CPlayerJass player = arguments.get(0).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
		...
		jassProgramVisitor.getJassNativeManager().createNative("ForcePlayerStartLocation", (arguments, globalScope, triggerScope) -> {
			final CPlayerJass player = arguments.get(0).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
			final Integer startLocIndex = arguments.get(1).visit(IntegerJassValueVisitor.getInstance());
			player.forceStartLocation(startLocIndex);
			return null;
		});
		jassProgramVisitor.getJassNativeManager().createNative("SetPlayerColor", (arguments, globalScope, triggerScope) -> {
			final CPlayerJass player = arguments.get(0).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
			final CPlayerColor playerColor = arguments.get(1).visit(ObjectJassValueVisitor.<CPlayerColor>getInstance());
			player.setColor(playerColor.ordinal());
			return null;
		});
		jassProgramVisitor.getJassNativeManager().createNative("SetPlayerAlliance", (arguments, globalScope, triggerScope) -> {
			final CPlayerJass player = arguments.get(0).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
			final CPlayerJass otherPlayer = arguments.get(1).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
			final CAllianceType whichAllianceSetting = arguments.get(2).visit(ObjectJassValueVisitor.<CAllianceType>getInstance());
		...
		jassProgramVisitor.getJassNativeManager().createNative("GetPlayerAlliance", (arguments, globalScope, triggerScope) -> {
			final CPlayerJass player = arguments.get(0).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
			final CPlayerJass otherPlayer = arguments.get(1).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
			final CAllianceType whichAllianceSetting = arguments.get(2).visit(ObjectJassValueVisitor.<CAllianceType>getInstance());
			return BooleanJassValue.of(player.hasAlliance(otherPlayer.getId(), whichAllianceSetting));
		});
		jassProgramVisitor.getJassNativeManager().createNative("SetPlayerTaxRate", (arguments, globalScope, triggerScope) -> {
			final CPlayerJass player = arguments.get(0).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
			final CPlayerJass otherPlayer = arguments.get(1).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
			final CPlayerState whichResource = arguments.get(2).visit(ObjectJassValueVisitor.<CPlayerState>getInstance());
		...
		jassProgramVisitor.getJassNativeManager().createNative("SetPlayerRacePreference", (arguments, globalScope, triggerScope) -> {
			final CPlayerJass player = arguments.get(0).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
			final CRacePreference whichRacePreference = arguments.get(1).visit(ObjectJassValueVisitor.<CRacePreference>getInstance());
			player.setRacePref(whichRacePreference);
			return null;
		});
		jassProgramVisitor.getJassNativeManager().createNative("SetPlayerRaceSelectable", (arguments, globalScope, triggerScope) -> {
			final CPlayerJass player = arguments.get(0).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
			final Boolean value = arguments.get(1).visit(BooleanJassValueVisitor.getInstance());
			player.setRaceSelectable(value);
			return null;
		});
		jassProgramVisitor.getJassNativeManager().createNative("SetPlayerController", (arguments, globalScope, triggerScope) -> {
			final CPlayerJass player = arguments.get(0).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
			final CMapControl controlType = arguments.get(1).visit(ObjectJassValueVisitor.<CMapControl>getInstance());
			player.setController(controlType);
			return null;
		});
		jassProgramVisitor.getJassNativeManager().createNative("SetPlayerName", (arguments, globalScope, triggerScope) -> {
			final CPlayerJass player = arguments.get(0).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
			final String name = arguments.get(1).visit(StringJassValueVisitor.getInstance());
			player.setName(name);
			return null;
		});
		jassProgramVisitor.getJassNativeManager().createNative("SetPlayerOnScoreScreen", (arguments, globalScope, triggerScope) -> {
			final CPlayerJass player = arguments.get(0).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
			final Boolean value = arguments.get(1).visit(BooleanJassValueVisitor.getInstance());
			player.setOnScoreScreen(value);
			return null;
		});
		jassProgramVisitor.getJassNativeManager().createNative("GetPlayerTeam", (arguments, globalScope, triggerScope) -> {
			final CPlayerJass player = arguments.get(0).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
			return new IntegerJassValue(player.getTeam());
		});
		jassProgramVisitor.getJassNativeManager().createNative("GetPlayerStartLocation", (arguments, globalScope, triggerScope) -> {
			final CPlayerJass player = arguments.get(0).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
			return new IntegerJassValue(player.getStartLocationIndex());
		});
		jassProgramVisitor.getJassNativeManager().createNative("GetPlayerColor", (arguments, globalScope, triggerScope) -> {
			final CPlayerJass player = arguments.get(0).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
			return new HandleJassValue(playercolorType, CPlayerColor.getColorByIndex(player.getColor()));
		});
		jassProgramVisitor.getJassNativeManager().createNative("GetPlayerSelectable", (arguments, globalScope, triggerScope) -> {
			final CPlayerJass player = arguments.get(0).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
			return BooleanJassValue.of(player.isRaceSelectable());
		});
		jassProgramVisitor.getJassNativeManager().createNative("GetPlayerController", (arguments, globalScope, triggerScope) -> {
			final CPlayerJass player = arguments.get(0).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
			return new HandleJassValue(mapcontrolType, player.getController());
		});
		jassProgramVisitor.getJassNativeManager().createNative("GetPlayerSlotState", (arguments, globalScope, triggerScope) -> {
			final CPlayerJass player = arguments.get(0).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
			return new HandleJassValue(playerslotstateType, player.getSlotState());
		});
		jassProgramVisitor.getJassNativeManager().createNative("GetPlayerTaxRate", (arguments, globalScope, triggerScope) -> {
			final CPlayerJass player = arguments.get(0).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
			final CPlayerJass otherPlayer = arguments.get(1).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
			final CPlayerState whichResource = arguments.get(2).visit(ObjectJassValueVisitor.<CPlayerState>getInstance());
			return new IntegerJassValue(player.getTaxRate(otherPlayer.getId(), whichResource));
		});
		jassProgramVisitor.getJassNativeManager().createNative("IsPlayerRacePrefSet", (arguments, globalScope, triggerScope) -> {
			final CPlayerJass player = arguments.get(0).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
			final CRacePreference racePref = arguments.get(1).visit(ObjectJassValueVisitor.<CRacePreference>getInstance());
			return BooleanJassValue.of(player.isRacePrefSet(racePref));
		});
		jassProgramVisitor.getJassNativeManager().createNative("GetPlayerName", (arguments, globalScope, triggerScope) -> {
			final CPlayerJass player = arguments.get(0).visit(ObjectJassValueVisitor.<CPlayerJass>getInstance());
		...
		jassProgramVisitor.getJassNativeManager().createNative("GetPlayerId", (arguments, globalScope, triggerScope) -> {
		...
		jassProgramVisitor.getJassNativeManager().createNative("GetPlayerNeutralAggressive", (arguments, globalScope, triggerScope) -> {
			return new IntegerJassValue(WarsmashConstants.MAX_PLAYERS - 4);
		});
		jassProgramVisitor.getJassNativeManager().createNative("GetBJPlayerNeutralVictim", (arguments, globalScope, triggerScope) -> {
			return new IntegerJassValue(WarsmashConstants.MAX_PLAYERS - 3);
		});
		jassProgramVisitor.getJassNativeManager().createNative("GetBJPlayerNeutralExtra", (arguments, globalScope, triggerScope) -> {
			return new IntegerJassValue(WarsmashConstants.MAX_PLAYERS - 2);
		});
		jassProgramVisitor.getJassNativeManager().createNative("GetPlayerNeutralPassive", (arguments, globalScope, triggerScope) -> {
			return new IntegerJassValue(WarsmashConstants.MAX_PLAYERS - 1);
		});
		jassProgramVisitor.getJassNativeManager().createNative("GetBJMaxPlayers", (arguments, globalScope, triggerScope) -> {
			return new IntegerJassValue(WarsmashConstants.MAX_PLAYERS - 4);
		});
		jassProgramVisitor.getJassNativeManager().createNative("GetBJMaxPlayerSlots", (arguments, globalScope, triggerScope) -> {
	...
	public static void registerTypingNatives(final JassProgramVisitor jassProgramVisitor, final HandleJassType raceType,
		...
		jassProgramVisitor.getJassNativeManager().createNative("ConvertRace", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
		...
		jassProgramVisitor.getJassNativeManager().createNative("ConvertAllianceType", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(alliancetypeType, CAllianceType.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertRacePref", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
		...
		jassProgramVisitor.getJassNativeManager().createNative("ConvertIGameState", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(igamestateType, CGameState.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertFGameState", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(fgamestateType, CGameState.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertPlayerState", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(playerstateType, CPlayerState.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertPlayerScore", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(playerscoreType, CPlayerScore.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertPlayerGameResult", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(playergameresultType, CPlayerGameResult.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertUnitState", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(unitstateType, CUnitState.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertAIDifficulty", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(aidifficultyType, AIDifficulty.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertGameEvent", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(gameeventType, JassGameEventsWar3.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertPlayerEvent", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(playereventType, JassGameEventsWar3.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertPlayerUnitEvent", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(playeruniteventType, JassGameEventsWar3.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertWidgetEvent", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(widgeteventType, JassGameEventsWar3.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertDialogEvent", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(dialogeventType, JassGameEventsWar3.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertUnitEvent", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(uniteventType, JassGameEventsWar3.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertLimitOp", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(limitopType, CLimitOp.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertUnitType", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(unittypeType, CUnitTypeJass.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertGameSpeed", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(gamespeedType, CGameSpeed.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertPlacement", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(placementType, CMapPlacement.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertStartLocPrio", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(startlocprioType, CStartLocPrio.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertGameDifficulty", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(gamedifficultyType, CMapDifficulty.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertGameType", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(gametypeType, CGameType.getById(i));
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertMapFlag", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(mapflagType, CMapFlag.getById(i));
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertMapVisibility", (arguments, globalScope, triggerScope) -> {
			return new HandleJassValue(mapvisibilityType, null);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertMapSetting", (arguments, globalScope, triggerScope) -> {
			return new HandleJassValue(mapsettingType, null);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertMapDensity", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(mapdensityType, CMapDensity.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertMapControl", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(mapcontrolType, CMapControl.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertPlayerColor", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
		...
		jassProgramVisitor.getJassNativeManager().createNative("ConvertPlayerSlotState", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(playerslotstateType, CPlayerSlotState.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertVolumeGroup", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(volumegroupType, CSoundVolumeGroup.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertCameraField", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(camerafieldType, CCameraField.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertBlendMode", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(blendmodeType, CBlendMode.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertRarityControl", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(raritycontrolType, CRarityControl.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertTexMapFlags", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(texmapflagsType, CTexMapFlags.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertFogState", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(fogstateType, CFogState.getById(i));
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertEffectType", (arguments, globalScope, triggerType) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(effecttypeType, CEffectType.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertVersion", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(versionType, CVersion.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertItemType", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(itemtypeType, CItemTypeJass.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertAttackType", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(attacktypeType, CAttackTypeJass.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertDamageType", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(damagetypeType, CDamageType.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertWeaponType", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(weapontypeType, CWeaponSoundTypeJass.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertSoundType", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
			return new HandleJassValue(soundtypeType, CSoundType.VALUES[i]);
		});
		jassProgramVisitor.getJassNativeManager().createNative("ConvertPathingType", (arguments, globalScope, triggerScope) -> {
			final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
		...
		jassProgramVisitor.getJassNativeManager().createNative("OrderId2String", (arguments, globalScope, triggerScope) -> {
			final Integer id = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
	...
	public static void registerConversionAndStringNatives(final JassProgramVisitor jassProgramVisitor,
		...
		jassProgramVisitor.getJassNativeManager().createNative("StringLength", (arguments, globalScope, triggerScope) -> {
			final String s = arguments.get(0).visit(StringJassValueVisitor.getInstance());
		...
		jassProgramVisitor.getJassNativeManager().createNative("GetLocalizedString", (arguments, globalScope, triggerScope) -> {
